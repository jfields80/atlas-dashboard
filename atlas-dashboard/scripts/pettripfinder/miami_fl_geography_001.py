...
SHARD_OUT = os.path.join(PKG, "markets", "proposed", "miami-fl.json")
...
def build():
    ...
    report = OrderedDict([
        ...
        ("registration_state",
         "SHADOW_UNTIL_REGISTERED: the market document is written to markets/proposed/miami-fl.json; the registry's "
