"""PTF-RICHMOND-VA-PARALLEL-SOURCE-READY-001 -- Phase 11B: the independents' own policy pages.
...
``data/acquisition/richmond_va_policy_pages_001/``).
...
recorded in ``markets/staging/richmond-va/raw_captures/brand_pages.json``
with the sha256 of the document they were read from, and the capture helper binds
them.

Output:
  launch_packages/pettripfinder/markets/reports/richmond_va_policy_pages_lane_001.json
"""
...
from scripts.pettripfinder import richmond_va_brand_inventory_001 as B  # noqa: E402
from scripts.pettripfinder import richmond_va_static_lane_001 as S      # noqa: E402
...
STATIC = os.path.join(REPORTS, "richmond_va_static_lane_001.json")
OUT = os.path.join(REPORTS, "richmond_va_policy_pages_lane_001.json")
DOCS = os.path.join(_DASH, "data", "acquisition", "richmond_va_policy_pages_001")
LINK_CAP = 6
...
EXTRA_TARGETS = [
    ...
    ("https://www.druryhotels.com/locations/richmond-va/drury-plaza-hotel-richmond", "drury plaza hotel richmond"),
    ("https://www.woodspring.com/extended-stay-hotels/locations/virginia/ashland/woodspring-suites-ashland-richmond-north",
     "woodspring suites ashland richmond north"),
    ("https://www.woodspring.com/extended-stay-hotels/locations/virginia/richmond/woodspring-suites-richmond-airport",
     "woodspring suites richmond airport"),
    ("https://www.woodspring.com/extended-stay-hotels/locations/virginia/richmond/woodspring-suites-richmond-west",
     "woodspring suites richmond west"),
    ("https://www.woodspring.com/extended-stay-hotels/locations/virginia/richmond/woodspring-suites-richmond-fort-lee",
