...
def cohort(package_dir):
    ...
    # PTF-INDIANAPOLIS-FOUNDER-RULINGS-013 retired five rows and routed the
    # renamed Baymont NW; nothing is under review any more.
    _c13 = os.path.join(package_dir, 'indianapolis_in_unrouted_cohort_013.json')
    ...
    _pick = next((c for c in (_c13, _c12, _c7, _c6, _c5, _c3) if os.path.isfile(c)), _c3)
