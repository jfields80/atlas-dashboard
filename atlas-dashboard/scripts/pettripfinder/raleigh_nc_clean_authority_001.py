"""PTF-RALEIGH-NC-FINAL-FRESH-CITY-PROOF-001 -- Phases 13 and 14: the clean set.
...
Nothing here fetches. Nothing here publishes. Output is Raleigh-local.
...
ATTENDED = os.path.join(REPORTS, "raleigh_nc_attended_capture_001.json")
STATIC = os.path.join(REPORTS, "raleigh_nc_free_static_lane_001.json")
...
def main(argv=None):
    ...
    ap.add_argument("--out", default=os.path.join(REPORTS, "raleigh_nc_clean_authority_001.json"))
