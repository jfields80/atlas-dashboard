"""PTF-PIEDMONT-TRIAD-NC-NORMAL-PRODUCTION-001 -- the Piedmont Triad's release contract.
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-piedmont-triad"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Piedmont Triad market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for the Piedmont Triad at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             ...
             "(census_membership_basis CORRIDOR_REGISTRY): a multi-core metro of Greensboro, "
             "Winston-Salem, High Point / Jamestown, Kernersville and the PTI airport corridor "
             "(CORE), the I-85 / I-40 approaches and Archdale / Trinity (CORRIDOR), and Oak Ridge "
             "/ Summerfield and northern Forsyth (FRINGE). Lexington, Thomasville, Burlington, "
             "Mebane, Asheboro, Mocksville and Bermuda Run are observed and refused by name. Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in piedmont_triad_nc_clean_authority_001.json with its class. No gate was "
