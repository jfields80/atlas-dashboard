"""PTF-WILMINGTON-NC-NORMAL-PRODUCTION-001 -- Wilmington's release contract.
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-wilmington"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Wilmington market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Wilmington at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             ...
             "(census_membership_basis CORRIDOR_REGISTRY): a coastal market of downtown and "
             "midtown Wilmington, the ILM airport / Mayfaire north side, Wrightsville Beach and "
             "Carolina / Kure Beach (CORE), Monkey Junction, Ogden / Porters Neck and Leland "
             "(CORRIDOR), and Castle Hayne (FRINGE). Southport, Oak Island, Bald Head Island, "
             "Hampstead, Topsail and Burgaw are observed and refused by name. Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in wilmington_nc_clean_authority_001.json with its class. No gate was "
