"""PTF-FAYETTEVILLE-NC-NORMAL-PRODUCTION-001 -- Phase 8: register Fayetteville.
...
from, and validates both against the contracts that own them:
  ...
  1. the committed POLICY PACKAGE  launch_packages/pettripfinder/hotel_policy_facts_fayetteville-nc.json
  ...
  2. the PROPOSED AUTHORITY        launch_packages/pettripfinder/fayetteville_nc_proposed_authority_002.json
...
------------------------------------------------------------------
Registration is not publication. Writing `markets/fayetteville-nc.json`, an
...
CLEAN = os.path.join(REPORTS, "fayetteville_nc_clean_authority_001.json")
CENSUS = os.path.join(PKG, "identity_census", "fayetteville-nc.json")
PACKAGE_OUT = os.path.join(PKG, "hotel_policy_facts_fayetteville-nc.json")
AUTHORITY_OUT = os.path.join(PKG, "fayetteville_nc_proposed_authority_002.json")
OBSERVED_AT = "2026-09-13"
CAPTURED_AT = "2026-09-13T03:50:00+00:00"
...
def build():
    ...
    for rec in clean["clean_pet_friendly"]:
        ...
        record = OrderedDict((
            ...
            # founder: this order registers Fayetteville without a row-by-row
    ...
    for rec in clean["clean_verified_no_pets"]:
        ...
        exclusions.append(OrderedDict((
            ...
            ("readiness_state", "READY"),
            ("founder_decision", "REGISTERED_NOT_AUTHORIZED_FOR_LAUNCH"),
            # NOT a person. This order registers Fayetteville without a row-by-row
    ...
    package = OrderedDict((
        ...
        ("as_of", OBSERVED_AT),
        ("note",
         "Fayetteville's committed policy package. Every record is one first-party read of the "
    ...
    authority = OrderedDict((
        ...
        ("what_this_is",
         "Fayetteville's authority as this order proposes it. Registration makes the market "
