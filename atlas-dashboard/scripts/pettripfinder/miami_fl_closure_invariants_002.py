"""PTF-MIAMI-FL-BROWSER-CLOSURE-002 -- Phase 7: the four SOURCE-READY-001 corrections, re-tested before sealing.
...
Output: launch_packages/pettripfinder/markets/reports/miami_fl_closure_invariants_002.json  (exit 1 on any failure)
"""
