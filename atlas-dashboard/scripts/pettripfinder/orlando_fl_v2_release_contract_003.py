"""PTF-ORLANDO-FL-V2-REGISTRATION-AND-FOUNDER-PACKET-003 -- Orlando's release contract.
...
WORK_ORDER = "PTF-ORLANDO-FL-V2-REGISTRATION-AND-FOUNDER-PACKET-003"
...
def main(argv=None) -> int:
    ...
    clean = _load(os.path.join(REPORTS, "orlando_fl_v2_clean_authority_001.json"))
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-orlando"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Orlando market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Orlando at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             "%d registered identities, built from zero by PTF-ORLANDO-FL-HARDENED-V2-SOURCE-READY-001 and "
             "closed by PTF-ORLANDO-FL-V2-TARGETED-COVERAGE-CLOSURE-002 at $0 USD (existing Firecrawl plan credits "
             "only), registered by %s. Membership is this market's own corridor postal partition "
             "(census_membership_basis CORRIDOR_REGISTRY): a multi-core theme-park, convention, airport and suburban "
             "market of 20 corridors over 62 postal codes -- Downtown Orlando, MCO Airport, International Drive / "
             "Universal, SeaWorld / I-Drive South, Lake Buena Vista, Walt Disney World, Kissimmee US-192 Maingate and "
             "Celebration / West 192 (CORE); South Orlando, Kissimmee East, Lake Mary / Sanford, East Orlando / UCF, "
             "Altamonte Springs / Longwood, North Orlando, Four Corners / Davenport, Flamingo Crossings / Winter "
             "Garden and Winter Park / Maitland (CORRIDOR); Clermont, St. Cloud and Apopka (FRINGE). Universal, the "
             "Convention Center, Disney Springs and Celebration are overlays, not pages. Timeshare, vacation-rental "
             "and resort-residence rows are excluded; DBPR condominium, dwelling and non-transient apartment "
             "licences never enter the graph. Every dual-brand / same-campus address-key collision stays HELD "
             "(no ruling is written). Rows "
             "the identity graph did not admit are recorded, not dropped: %s."
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in orlando_fl_v2_clean_authority_001.json with its class. No gate was "
