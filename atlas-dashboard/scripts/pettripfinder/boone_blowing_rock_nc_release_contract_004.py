"""PTF-BOONE-BLOWING-ROCK-NC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 -- Boone - Blowing Rock's release contract.
...
WORK_ORDER = "PTF-BOONE-BLOWING-ROCK-NC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002"
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-boone-blowing-rock"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Boone - Blowing Rock market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Boone - Blowing Rock at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             "%d registered identities, built from zero by PTF-BOONE-BLOWING-ROCK-NC-PARALLEL-SOURCE-READY-001 "
             "at $0 and no paid provider call, registered by %s. "
             "Membership is this market's own corridor postal partition "
             "(census_membership_basis CORRIDOR_REGISTRY): a High Country market of Boone / Appalachian "
             "State and Blowing Rock (CORE), Valle Crucis / Vilas and Deep Gap (CORRIDOR) and Sugar Grove / "
             "Zionville / Todd (FRINGE). Banner Elk, Sugar Mountain, Seven Devils, Beech Mountain and the "
             "rest of Avery County are observed, refused and preserved for a future banner-elk-sugar-beech-nc "
             "market; West Jefferson, Lenoir and Wilkesboro are named and refused. Cabins, condos, rental "
             "companies and campgrounds are never admitted. Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in boone_blowing_rock_nc_clean_authority_001.json with its class. No gate was "
