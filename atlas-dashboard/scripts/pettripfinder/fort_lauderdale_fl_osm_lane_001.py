"""PTF-FORT-LAUDERDALE-FL-HARDENED-SOURCE-READY-001 -- Phase 9B: the OpenStreetMap lane.

Reads the local Geofabrik Florida extract (the 2026-09-15 snapshot PTF-TAMPA-FL-HARDENED-V2 downloaded, reused
unchanged as owned data) (ODbL, (c) OpenStreetMap
...
Output:
  launch_packages/pettripfinder/markets/reports/fort_lauderdale_fl_osm_lane_001.json
"""
...
CONFIG = os.path.join(_DASH, "scripts", "pettripfinder", "discovery", "config",
                      "fort_lauderdale_fl.json")
OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "reports",
                   "fort_lauderdale_fl_osm_lane_001.json")

#: guest_house, chalet and apartment are kept too: Broward's vacation-rental and resort-condo stock,
#: especially on Hollywood Beach, the Galt Ocean Mile and Lauderdale-by-the-Sea, is often tagged that way, and the
...
def build():
    ...
    return OrderedDict([
        ...
        ("source", OrderedDict([
            ...
            ("pbf_snapshot",
             "the 2026-09-15 Geofabrik Florida download made by PTF-TAMPA-FL-HARDENED-V2 and reused as owned data (656,564,714 bytes); the upstream "
