"""PTF-FORT-LAUDERDALE-FL-HARDENED-SOURCE-READY-001 -- Phase 12E: Firecrawl ROUTE DISCOVERY on the two Firecrawl-routed families
...
could not make. The page is persisted by sha256 under data/acquisition/fort_lauderdale_fl_firecrawl_discovery/ and only
the property ROUTES are read from it -- never a policy.

Attempt cap: 8 pages. Credit floor: 400.

Output: launch_packages/pettripfinder/markets/reports/fort_lauderdale_fl_firecrawl_discovery_001.json
"""
...
DOCS = os.path.join(_DASH, "data", "acquisition", "fort_lauderdale_fl_firecrawl_discovery")
OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "reports", "fort_lauderdale_fl_firecrawl_discovery_001.json")
CAP = 12
FLOOR = 400
PAGES = [
    ("CHOICE", "https://www.choicehotels.com/florida/fort-lauderdale/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/hollywood/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/dania-beach/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/pompano-beach/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/deerfield-beach/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/plantation/hotels"),
    # IHG's destination path spells the state in full (Orlando V2 measured the /fl/ form as 404)
    ("IHG", "https://www.ihg.com/destinations/us/en/united-states/florida/fort-lauderdale-hotels"),
    ("IHG", "https://www.ihg.com/destinations/us/en/united-states/florida/hollywood-hotels"),
]
CAP = 8
...
def main():
    ...
    doc = OrderedDict([
        ("schema", "ptf-firecrawl-discovery/1.0"), ("work_order", WORK_ORDER), ("market_id", "fort-lauderdale-fl"),
