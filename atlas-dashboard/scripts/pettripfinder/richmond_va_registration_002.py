...
PACKAGE_OUT = os.path.join(STAGING, "launch_package", "hotel_policy_facts_richmond-va.json")
AUTHORITY_OUT = os.path.join(STAGING, "richmond_va_proposed_authority_002.json")
