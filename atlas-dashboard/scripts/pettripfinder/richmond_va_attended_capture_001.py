"""PTF-RICHMOND-VA-PARALLEL-SOURCE-READY-001 -- Phases 10-14: the first-party policy reads.
...
Cloned from the Charleston SC capture helper (itself from Savannah GA, Boone - Blowing Rock NC and Atlanta GA). Families and surfaces:
  ...
  WYNDHAM   plain-client reads (``richmond_va_wyndham_lane_001``): the overview page
...
``data/acquisition/richmond_va_attended/``; each payload file's canonical JSON
...
Output:
  launch_packages/pettripfinder/markets/reports/richmond_va_attended_capture_001.json
"""
...
RAW = os.path.join(PKG, "markets", "staging", "richmond-va", "raw_captures")
REGISTRY = os.path.join(REPORTS, "richmond_va_corridor_registry_001.json")
OUT = os.path.join(REPORTS, "richmond_va_attended_capture_001.json")
...
PAYLOAD_DIGESTS = OrderedDict([
    ("ihg_rows.json", "395de226ff4ff83e5a70d24bc1b3a62790f33c71ebe3406766223427e5c8bc21"),
    ("hyatt_rows.json", "4aec891ff718bb6ddfaf3b10c0053d594227b3da88a3eacaee68f59dd2fec1f4"),
    ("hilton_rows.json", "ab02b5a9f6042a0f604720485cb778f6f8896934a2cd21811eb2d3c6afa00ea0"),
    ("marriott_rows.json", "daf7ff9d7891c06d7528f42552e05c603c9ff6700408bd20395ff8ef3881234e"),
    ("choice_rows.json", "b349323f53be09e5a45e2760d1c079619318004f1a773c33f40ef54c9cc5747f"),
    ("bestwestern_rows.json", "2b74d5c97105a4b739a852c53da4650ec2374a9e3a4f38e3e154c68454503de8"),
])
