"""PTF-JACKSONVILLE-FL-HARDENED-SOURCE-READY-001 -- the vacation-rental / timeshare / resort-residence / venue filter.
...
#: own first-party evidence was read. NORTHEAST FLORIDA's exposure is its GOLF-RESORT and BARRIER-ISLAND
#: CONDOMINIUM stock: Nassau County carries 1,130 individually licensed resort-condominium units against 32
#: hotel-rank licences (Amelia Island Plantation and the Omni Amelia Island Resort villa programmes), St. Johns
#: County 1,472 (overwhelmingly in the refused St. Augustine codes, plus Sawgrass and TPC Sawgrass villas and
#: Ponte Vedra Inn & Club cottages), and Duval 1,268 vacation dwellings against 193 hotel-rank licences (the
#: Jacksonville Beach oceanfront towers). Member-only or guest-of-member club lodging is not public lodging.
#: EMPTY AT AUTHORING TIME. Nothing is inherited: West Palm Beach's Marriott's Oceana Palms timeshare ruling
#: belongs to Riviera Beach and is NOT carried here, exactly as Fort Lauderdale's BeachPlace Towers ruling was
#: not carried into that market. A row is added only after THIS market's own first-party read proves it.
NOT_LODGING_WHY = {
}
...
#: NORTHEAST FLORIDA: a licence or listing whose own name is a COMPANY (LLC / Inc / management / realty) and not a hotel, or whose
