"""PTF-CHARLOTTE-NC-ZERO-TO-LIVE-BENCHMARK-001 -- Charlotte's release contract.

Every number here is DERIVED at run time from Charlotte's own committed
...
than facts about Charlotte.

A passing contract means Charlotte's assembled package is STRUCTURALLY
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-charlotte"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Charlotte market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Charlotte at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             ...
             "SOUTH CAROLINA state line. Charlotte is this project's first market to span two "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in charlotte_nc_clean_authority_001.json with its class. No gate was "
