"""PTF-ATLANTA-GA-PARALLEL-SOURCE-READY-001 -- Phase 10: complete accounting.
...
def requested_area_coverage(hotels, pf, np_):
    ...
    OVERLAY (atlanta_ga_geography_001.COVERAGE_AREAS). Reporting only."""
...
def build():
    ...
    doc = OrderedDict([
        ...
        ("factory_code_changed", "NO -- every changed path is a atlanta_ga_* helper, the market's discovery config, or a document under the market's own proposed / staging / report paths"),
        ...
        ("next_order", [
            ...
            "rebase this branch on it; copy markets/proposed/atlanta-ga.json, identity_census_proposed/atlanta-ga.json and the staged launch_package documents into their registered paths",
