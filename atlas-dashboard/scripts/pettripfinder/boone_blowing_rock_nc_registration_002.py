...
PACKAGE_OUT = os.path.join(STAGING, "launch_package", "hotel_policy_facts_boone-blowing-rock-nc.json")
AUTHORITY_OUT = os.path.join(STAGING, "boone_blowing_rock_nc_proposed_authority_002.json")
...
def build():
    ...
    package = OrderedDict((
        ...
        ("as_of", OBSERVED_AT),
        ("note",
         "Boone - Blowing Rock's STAGED policy package (shadow until registered). Every record is one first-party read of the "
    ...
    authority = OrderedDict((
        ...
        ("what_this_is",
         "Boone - Blowing Rock's authority as this order proposes it, STAGED and not registered. Registration makes the market "
