"""PTF-SAVANNAH-GA-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 -- Savannah's release contract.
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-savannah"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Savannah market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Savannah at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             "%d registered identities, built from zero by PTF-SAVANNAH-GA-PARALLEL-SOURCE-READY-001 "
             "at $0 and no paid provider call, registered by %s. "
             "Membership is this market's own corridor postal partition "
             "(census_membership_basis CORRIDOR_REGISTRY): a multi-core tourism, airport and interstate market of "
             "10 corridors over 15 postal codes -- the Historic District / River Street, Hutchinson Island, Midtown, "
             "the Southside, the SAV airport / Garden City, Pooler and the I-95 Gateway (CORE); Port Wentworth "
             "(CORRIDOR); Richmond Hill and the Wilmington / Skidaway islands (FRINGE). Tybee Island is OUTSIDE and "
             "preserved for a future tybee-island-ga market; Hilton Head, Bluffton, Beaufort, Hardeeville, Rincon, "
             "Hinesville, Statesboro and Brunswick are named and refused. Address-key collisions publish both hotels "
             "only under same-campus rulings in identity_resolutions.json; street-directional collisions stay held. "
             "Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in savannah_ga_clean_authority_001.json with its class. No gate was "
