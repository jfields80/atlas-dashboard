"""PTF-RALEIGH-NC-FINAL-FRESH-CITY-PROOF-001 -- the exact final candidate.
...
So the candidate has to be assembled with Raleigh participating.

That is not the same thing as DECIDING that Raleigh participates. This module
stages the participation document Raleigh's launch would use, builds against
...
Output: launch_packages/pettripfinder/markets/reports/raleigh_nc_candidate_assembly_008.json
"""
...
OUT = REPORTS / "raleigh_nc_candidate_assembly_008.json"
STAGED_NOTE = (
    "Raleigh staged as FOUNDER_AUTHORIZED_FOR_LAUNCH for the DURATION OF THIS BUILD ONLY, "
    "by PTF-RALEIGH-NC-FINAL-FRESH-CITY-PROOF-001, so that the candidate carries the "
