"""PTF-SAN-DIEGO-CA-HARDENED-SOURCE-READY-001 -- the independents' OWN sites the Places route-discovery lane found.

For every unrouted census identity that san_diego_ca_places_route_discovery_001 bound (street number + ZIP) to a place
carrying a website, this lane reads that site with the same reader and the same binding discipline as the
independents' policy-pages lane (san_diego_ca_policy_pages_lane_001.read_sites): the site's own home or policy page must
...
Output:
  launch_packages/pettripfinder/markets/staging/san-diego-ca/raw_captures/closure_static_rows.json
"""
...
from scripts.pettripfinder import san_diego_ca_policy_pages_lane_001 as PP  # noqa: E402
