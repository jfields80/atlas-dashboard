"""PTF-FAYETTEVILLE-NC-NORMAL-PRODUCTION-001 -- Fayetteville's release contract.
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-fayetteville"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Fayetteville market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Fayetteville at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             ...
             "(census_membership_basis CORRIDOR_REGISTRY): a military / I-95 travel market of "
             "downtown / Haymount, Cross Creek / Skibo / Bragg Boulevard, FAY airport, North "
             "Fayetteville, the I-95 central exits / Eastover, Spring Lake / Fort Liberty and Hope "
             "Mills (CORE), Wade (CORRIDOR) and Raeford (FRINGE). Fort Liberty on-post lodging, "
             "Southern Pines / Pinehurst, Sanford, Lumberton, Dunn and Clinton are observed or "
             "named and refused. Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in fayetteville_nc_clean_authority_001.json with its class. No gate was "
