"""PTF-MIAMI-FL-HARDENED-SOURCE-READY-001 -- Phase 12A: one first-party route per census identity.
...
census ADMITTED, the first-party route it will be read at and which source stated it, in this order:
  ...
  2. the website the destination bureau (Greater Miami CVB) links for the listing joined to this building;
...
Nothing here fetches. Output:
  launch_packages/pettripfinder/markets/reports/miami_fl_routing_001.json
"""
...
_NOT_A_PROPERTY_ROUTE = re.compile(
    ...
    r"miamiandbeaches\.com|bringfido|airbnb|vrbo|priceline|agoda|trivago|orbitz)", re.I)
