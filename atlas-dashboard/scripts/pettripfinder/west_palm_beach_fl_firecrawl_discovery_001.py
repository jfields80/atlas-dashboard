"""PTF-WEST-PALM-BEACH-FL-HARDENED-SOURCE-READY-001 -- Phase 12E: Firecrawl ROUTE DISCOVERY on the two Firecrawl-routed families
...
could not make. The page is persisted by sha256 under data/acquisition/west_palm_beach_fl_firecrawl_discovery/ and only
the property ROUTES are read from it -- never a policy.

Attempt cap: 8 pages. Credit floor: 400.

Output: launch_packages/pettripfinder/markets/reports/west_palm_beach_fl_firecrawl_discovery_001.json
"""
...
DOCS = os.path.join(_DASH, "data", "acquisition", "west_palm_beach_fl_firecrawl_discovery")
OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "reports", "west_palm_beach_fl_firecrawl_discovery_001.json")
CAP = 12
FLOOR = 400
PAGES = [
    ("CHOICE", "https://www.choicehotels.com/florida/west-palm-beach/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/palm-beach-gardens/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/riviera-beach/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/jupiter/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/lake-worth/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/boynton-beach/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/delray-beach/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/boca-raton/hotels"),
    # IHG's destination path spells the state in full (Orlando V2 measured the /fl/ form as 404)
    ("IHG", "https://www.ihg.com/destinations/us/en/united-states/florida/west-palm-beach-hotels"),
    ("IHG", "https://www.ihg.com/destinations/us/en/united-states/florida/boca-raton-hotels"),
    ("IHG", "https://www.ihg.com/destinations/us/en/united-states/florida/palm-beach-gardens-hotels"),
    ("IHG", "https://www.ihg.com/destinations/us/en/united-states/florida/jupiter-hotels"),
]
CAP = 8
...
def main():
    ...
    doc = OrderedDict([
        ("schema", "ptf-firecrawl-discovery/1.0"), ("work_order", WORK_ORDER), ("market_id", "west-palm-beach-fl"),
