"""PTF-JACKSONVILLE-NC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 -- Jacksonville's release contract.
...
WORK_ORDER = "PTF-JACKSONVILLE-NC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002"
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-jacksonville"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Jacksonville market through %s. "
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             "%d registered identities, built from zero by PTF-JACKSONVILLE-NC-PARALLEL-SOURCE-READY-001 "
             "at $0 and no paid provider call, registered by %s. "
             "Membership is this market's own corridor postal partition "
             "(census_membership_basis CORRIDOR_REGISTRY): a military / US-17 travel market of Western "
             "Boulevard, downtown / Marine Boulevard / US-17 / New River and Midway Park (CORE), Hubert "
             "(CORRIDOR) and Sneads Ferry, Swansboro and Richlands (FRINGE). Camp Lejeune / MCAS New River "
             "on-base lodging is refused as MILITARY_GOVERNMENT_NONPUBLIC; North Topsail Beach, Cape Carteret "
             "and Cedar Point are refused by municipality in every admitted postal code; Topsail Island, the "
             "Crystal Coast, Maysville and Wilmington are named and refused. Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in jacksonville_nc_clean_authority_001.json with its class. No gate was "
