"""PTF-MIAMI-FL-REGISTRATION-AND-STAGING-004 -- Miami's release contract.
...
WORK_ORDER = "PTF-MIAMI-FL-REGISTRATION-AND-STAGING-004"
SOURCE_ORDER = "PTF-MIAMI-FL-HARDENED-SOURCE-READY-001"
MARKET_ID = "miami-fl"
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-miami"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Greater Miami market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Miami at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             "%d registered identities, built from zero by %s on the repaired release-factory "
             "lineage and closed through the authorized attended-browser lane by "
             "PTF-MIAMI-FL-BROWSER-CLOSURE-002 and PTF-MIAMI-FL-MARRIOTT-TERMINAL-CLOSURE-003, "
             "registered by %s. Membership is this market's own corridor postal partition "
             "(census_membership_basis CORRIDOR_REGISTRY): 20 corridors over 79 Miami-Dade postal "
             "codes. Fort Lauderdale, West Palm Beach and the Florida Keys are named and refused "
             "and preserved for their own future markets; Downtown and Brickell are one corridor "
             "because ZIP 33131 straddles the Miami River, and PortMiami is not a corridor of its "
             "own because it would duplicate downtown-brickell exactly. Individual vacation "
             "houses, condo units, rental-management portfolios and timeshare inventory are never "
             "admitted. Rows the identity graph did not admit are recorded, not dropped: %s."
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "miami_fl_clean_authority_001.json with its class. No gate was lowered to "
                "preserve a count."
