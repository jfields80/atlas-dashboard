"""PTF-HAMPTON-ROADS-VA-PARALLEL-SOURCE-READY-001 -- Phase 10/11: the Wyndham first-party lane (plain client).
...
``data/acquisition/hampton_roads_va_wyndham_001/``. The pet quote is read from the
...
Output:
  data/acquisition/hampton_roads_va_attended/wyndham_rows.json   (the capture helper's input shape)
  launch_packages/pettripfinder/markets/reports/hampton_roads_va_wyndham_lane_001.json
"""
...
RAW_OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "staging", "hampton-roads-va", "raw_captures", "wyndham_rows.json")
REPORT_OUT = os.path.join(REPORTS, "hampton_roads_va_wyndham_lane_001.json")
B.DOCS = os.path.join(_DASH, "data", "acquisition", "hampton_roads_va_wyndham_001")
