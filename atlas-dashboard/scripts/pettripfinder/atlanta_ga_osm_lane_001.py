"""PTF-ATLANTA-GA-PARALLEL-SOURCE-READY-001 -- Phase 4A: the OpenStreetMap lane.
...
Output:
  launch_packages/pettripfinder/markets/reports/atlanta_ga_osm_lane_001.json
"""
...
def build():
    ...
    return OrderedDict([
        ...
        ("source", OrderedDict([
            ...
            ("pbf_snapshot",
             "the Geofabrik Georgia extract downloaded by this order on 2026-09-13; the "
             "upstream file is republished daily, so this md5 is the snapshot's own"),
