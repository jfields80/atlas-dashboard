"""PTF-SAN-DIEGO-CA-HARDENED-SOURCE-READY-001 -- Phases 10, 13, 20-25 and 29: the machine-readable accounting.
...
Output: launch_packages/pettripfinder/markets/reports/san_diego_ca_source_ready_accounting_001.json
"""
...
from scripts.pettripfinder.san_diego_ca_nonhotel_rulings_001 import exclusion_class  # noqa: E402
...
def main():
    ...
    fc2 = L("san_diego_ca_firecrawl_pass_002.json", {}) or {}
    fc3 = L("san_diego_ca_firecrawl_pass_003.json", {}) or {}
    bpr = L("san_diego_ca_brand_page_reads_001.json", {}) or {}
    disc = L("san_diego_ca_firecrawl_discovery_001.json", {}) or {}
    static = L("san_diego_ca_free_static_capture_001.json", {}) or {}
    comp = L("san_diego_ca_competitor_challenge_001.json", {}) or {}
    recon = L("san_diego_ca_competitor_reconciliation_001.json", {}) or {}
    dbpr = L("san_diego_ca_btc_lane_001.json", {}) or {}
    osm = L("san_diego_ca_osm_lane_001.json", {}) or {}
    brand = L("san_diego_ca_brand_inventory_001.json", {}) or {}
    roster = L("san_diego_ca_destination_roster_001.json", {}) or {}
    routing = L("san_diego_ca_routing_001.json", {}) or {}
    wyndham = L("san_diego_ca_wyndham_lane_001.json", {}) or {}
    esa = L("san_diego_ca_esa_lane_001.json", {}) or {}
    places = L("san_diego_ca_places_route_discovery_001.json", {}) or {}
    ...
    creport = L("san_diego_ca_census_reconciliation_001.json", {}) or {}

    # corridors
    cor = OrderedDict()
    for slug, name, _a, klass, _m, _z, _d in GEO.CORRIDORS:
        cid = "san-diego-ca__" + slug
    ...
    # SAN DIEGO: the attended-browser lane this order actually exercised (san_diego_ca_browser_lane_001),
    # counted per brand family so the brand table reports reads and denials, not a placeholder zero.
    _blp = os.path.join(R, "san_diego_ca_browser_lane_001.json")
    ...
    for h in (L("san_diego_ca_brand_inventory_001.json", {}) or {}).get("leads", []):
    ...
    doc = OrderedDict([
        ("schema", "ptf-source-ready-accounting/1.0"), ("work_order", WORK_ORDER), ("market_id", "san-diego-ca"),
        ...
        ("exclusions", OrderedDict([
            ...
            ("closed_note", "No row was classified CLOSED: no first-party read in this order stated a closure."),
        ])),
