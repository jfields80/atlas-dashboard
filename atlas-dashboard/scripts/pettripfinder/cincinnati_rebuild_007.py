# -*- coding: utf-8 -*-
"""PTF-CINCINNATI-FREE-LANE-APPLICATION-007 Phase 8 -- rebuild the market.

    python -m scripts.pettripfinder.cincinnati_rebuild_007 --write
    ...
    for key, row in sorted(census.items()):
        ...
        item = OrderedDict((
            ...
            ("state_override_reason",
             "Ruled HOLD_FOR_IDENTITY_REVIEW by the founder in %s; three of "
             "four identity signals disagree with the property page and the "
             "row stays unresolved until identity is mechanically settled."
