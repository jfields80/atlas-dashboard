"""PTF-MIAMI-FL-HARDENED-SOURCE-READY-001 -- Phase 9B: the OpenStreetMap lane.
...
Output:
  launch_packages/pettripfinder/markets/reports/miami_fl_osm_lane_001.json
"""
...
OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "reports",
                   "miami_fl_osm_lane_001.json")

#: guest_house, chalet and apartment are kept too: Miami's vacation-rental and resort-condo stock,
#: especially on Miami Beach and in Sunny Isles, is often tagged that way, and the census must SEE a rental to refuse it
#: by decision.
