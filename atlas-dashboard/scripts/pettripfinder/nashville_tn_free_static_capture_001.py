"""PTF-NASHVILLE-TN-NEW-MARKET-001 -- Phases 10 and 13, free first-party static capture.

One HTTPS GET per route through the canonical gates, for two cohorts:

  ROUTED          every confirmed Nashville identity that carries a first-party
...
Output:
  launch_packages/pettripfinder/markets/reports/nashville_tn_free_static_capture_001.json
"""
...
BRANDS = [
    ...
    ("GAYLORD", r"gaylord|opryland resort"),
]
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--run-id", default="nashville_tn_free_static_001")
