"""PTF-GREENVILLE-NC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 -- Greenville's release contract.
...
WORK_ORDER = "PTF-GREENVILLE-NC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002"
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-greenville"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Greenville market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Greenville at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             "%d registered identities, built from zero by PTF-GREENVILLE-NC-PARALLEL-SOURCE-READY-001 "
             "at $0 and no paid provider call, registered by %s. "
             "Membership is this market's own corridor postal partition "
             "(census_membership_basis CORRIDOR_REGISTRY): a university / medical / convention travel "
             "market of the Convention Center / Memorial Drive / ECU Health medical district / PGV "
             "Airport postal code (with Greenville's PO-box postal codes) and Downtown / ECU (CORE), "
             "Winterville (CORRIDOR), Ayden and Simpson (FRINGE). Farmville, Grifton, Kinston, "
             "Washington, Tarboro and Williamston are observed and refused; Rocky Mount, Wilson, New "
             "Bern and Greenville SC are named and refused. Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in greenville_nc_clean_authority_001.json with its class. No gate was "
