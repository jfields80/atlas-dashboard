"""PTF-RICHMOND-VA-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 -- Richmond's release contract.
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-richmond"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Richmond market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Richmond at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             "%d registered identities, built from zero by PTF-RICHMOND-VA-PARALLEL-SOURCE-READY-001 "
             "at $0 and no paid provider call, registered by %s. "
             "Membership is this market's own corridor postal partition "
             "(census_membership_basis CORRIDOR_REGISTRY): a multi-core metro of 12 corridors over 43 postal "
             "codes -- Downtown / Shockoe / VCU Medical Center, VCU Monroe Park / Fan / Museum District, West End, "
             "Short Pump, Innsbrook / Glen Allen, RIC Airport / Sandston, I-95 North, I-95 South and Midlothian / "
             "Chesterfield (CORE); Mechanicsville, Ashland and Chester (CORRIDOR). Petersburg, Colonial Heights, "
             "Hopewell and Prince George are OUTSIDE and preserved for a future petersburg-tri-cities-va market; "
             "Powhatan, Goochland, Hanover Courthouse, Doswell, New Kent, Williamsburg, Fredericksburg, "
             "Charlottesville, Farmville and Tidewater are named and refused. Address-key collisions publish both "
             "hotels only under same-campus rulings in identity_resolutions.json. Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in richmond_va_clean_authority_001.json with its class. No gate was "
