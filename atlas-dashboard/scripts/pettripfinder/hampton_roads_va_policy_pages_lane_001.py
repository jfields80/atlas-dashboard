"""PTF-HAMPTON-ROADS-VA-PARALLEL-SOURCE-READY-001 -- Phase 11B: the independents' own policy pages.

Richmond independents (like Charleston's) publish their pet policy on a subpage (``/pet-policy``,
...
``data/acquisition/hampton_roads_va_policy_pages_001/``).
...
recorded in ``markets/staging/hampton-roads-va/raw_captures/brand_pages.json``
with the sha256 of the document they were read from, and the capture helper binds
them.

Output:
  launch_packages/pettripfinder/markets/reports/hampton_roads_va_policy_pages_lane_001.json
"""
...
from scripts.pettripfinder import hampton_roads_va_brand_inventory_001 as B  # noqa: E402
from scripts.pettripfinder import hampton_roads_va_static_lane_001 as S      # noqa: E402
...
STATIC = os.path.join(REPORTS, "hampton_roads_va_static_lane_001.json")
OUT = os.path.join(REPORTS, "hampton_roads_va_policy_pages_lane_001.json")
DOCS = os.path.join(_DASH, "data", "acquisition", "hampton_roads_va_policy_pages_001")
LINK_CAP = 6
...
EXTRA_TARGETS = [
    # Brand property pages that answer a plain client (the brands' own sitemap routes).
    ("https://www.woodspring.com/extended-stay-hotels/locations/virginia/chesapeake-norfolk/woodspring-suites-chesapeake-norfolk-greenbrier",
     "woodspring suites chesapeake norfolk greenbrier"),
    ("https://www.woodspring.com/extended-stay-hotels/locations/virginia/chesapeake-norfolk/woodspring-suites-chesapeake-norfolk-south",
     "woodspring suites chesapeake norfolk south"),
    ("https://www.woodspring.com/extended-stay-hotels/locations/virginia/chesapeake-norfolk/woodspring-suites-virginia-beach",
     "woodspring suites virginia beach"),
    ("https://www.woodspring.com/extended-stay-hotels/locations/virginia/yorktown/woodspring-suites-yorktown-newport-news",
     "woodspring suites yorktown newport news"),
    ("https://www.magnusonhotels.com/magnuson-hotel-virginia-beach/", "magnuson hotel virginia beach"),
]
