...
def build_methodology_page() -> str:
    body = (
        ...
        "<p>We only show a property photograph when we have the right to publish one. Until a "
        "property supplies or licenses an image, we display a neutral branded placeholder "
        "rather than a stock or third-party photo &mdash; a placeholder never implies anything "
        "about the property beyond its verified pet policy.</p>"
        "<h2>Limitations</h2>"
