"""PTF-ASHEVILLE-NC-NORMAL-PRODUCTION-001 -- Asheville's release contract.
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-asheville"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Asheville market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Asheville at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             ...
             "(census_membership_basis CORRIDOR_REGISTRY): a mountain travel market of downtown, "
             "Biltmore Village / Biltmore Estate / South Asheville, Tunnel Road, West Asheville, "
             "North Asheville / Woodfin and Arden / Fletcher / AVL (CORE), Candler, Weaverville and "
             "Swannanoa (CORRIDOR), and Black Mountain (FRINGE). Hendersonville, Flat Rock, Mills "
             "River, Waynesville, Canton, Mars Hill and Chimney Rock / Lake Lure are observed and "
             "refused by name. Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in asheville_nc_clean_authority_001.json with its class. No gate was "
