"""PTF-RALEIGH-NC-FINAL-FRESH-CITY-PROOF-001 -- Phases 15 and 16.
...
Output: launch_packages/pettripfinder/markets/reports/raleigh_nc_coverage_006.json
"""
...
OUT = os.path.join(REPORTS, "raleigh_nc_coverage_006.json")
...
def build():
    ...
    gap = _load(os.path.join(REPORTS, "raleigh_nc_competitor_gap_matrix_001.json"), {})
    package = _load(os.path.join(PKG, "hotel_policy_facts_%s.json" % MARKET_ID))
    static = _load(os.path.join(REPORTS, "raleigh_nc_free_static_lane_001.json"), {})
    sitemaps = _load(os.path.join(REPORTS, "raleigh_nc_brand_sitemaps_001.json"), {})
    ...
    families_unresolved = OrderedDict((
        ...
        ("BEST_WESTERN_ESA_REDROOF_MOTEL6_HYATT_SONESTA", OrderedDict((
            ...
            ("why", "each refused this project's plain client on this run -- Best Western 403, "
                    ...
                    "never evidence that the family has no Raleigh property."),
