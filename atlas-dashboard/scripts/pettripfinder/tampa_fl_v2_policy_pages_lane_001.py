"""PTF-TAMPA-FL-HARDENED-V2-SOURCE-READY-001 -- Phase 12G: independents' own policy / FAQ / pet pages (plain client).
...
The sentences are the candidate quote; facts are read by the shared reader in tampa_fl_v2_policy_reads_001 and
judged by the first-party gate and the negation guard in the clean authority. Documents persisted by sha256 under
data/acquisition/tampa_fl_v2_policy_pages_001/.

Output:
  launch_packages/pettripfinder/markets/staging/tampa-fl/raw_captures/policy_pages_rows.json
"""
...
B.DOCS = os.path.join(_DASH, "data", "acquisition", "tampa_fl_v2_policy_pages_001")
PKG = os.path.join(_DASH, "launch_packages", "pettripfinder")
ROUTING = os.path.join(PKG, "markets", "reports", "tampa_fl_v2_routing_001.json")
OUT = os.path.join(PKG, "markets", "staging", "tampa-fl", "raw_captures", "policy_pages_rows.json")
