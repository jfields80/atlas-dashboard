"""PTF-BANNER-ELK-SUGAR-BEECH-NC-PARALLEL-SOURCE-READY-001 -- Phases 13 and 14: the clean set.
...
Output:
  launch_packages/pettripfinder/markets/reports/banner_elk_sugar_beech_nc_clean_authority_001.json
"""
...
ATTENDED = os.path.join(REPORTS, "banner_elk_sugar_beech_nc_attended_capture_001.json")
STATIC = os.path.join(REPORTS, "banner_elk_sugar_beech_nc_free_static_lane_001.json")
...
def main(argv=None):
    ...
    ap.add_argument("--out", default=os.path.join(REPORTS, "banner_elk_sugar_beech_nc_clean_authority_001.json"))
