"""PTF-PINEHURST-SOUTHERN-PINES-NC-PARALLEL-SOURCE-READY-001 -- Phase 10/11: the free static first-party lane.
...
addressed by sha256, under ``data/acquisition/pinehurst_southern_pines_nc_static_001/``, and this
...
recorded in ``pinehurst_southern_pines_nc_attended/brand_pages.json`` with the document sha256 they
...
Output:
  launch_packages/pettripfinder/markets/reports/pinehurst_southern_pines_nc_static_lane_001.json
"""
...
OUT = os.path.join(REPORTS, "pinehurst_southern_pines_nc_static_lane_001.json")
B.DOCS = os.path.join(_DASH, "data", "acquisition", "pinehurst_southern_pines_nc_static_001")
...
BROWSER_ONLY = ("marriott.com", "hilton.com", "ihg.com", "choicehotels.com", "hyatt.com",
                "bestwestern.com", "redroof.com", "motel6.com", "extendedstayamerica.com", "reservations.com", "obxlodging.com",
                "omnihotels.com", "radissonhotels.com", "fourseasons.com", "yelp.com", "sonder.com")
