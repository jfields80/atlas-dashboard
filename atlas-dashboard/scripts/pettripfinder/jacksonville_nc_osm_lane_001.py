"""PTF-JACKSONVILLE-NC-PARALLEL-SOURCE-READY-001 -- Phase 4A: the OpenStreetMap lane.
...
Output:
  launch_packages/pettripfinder/markets/reports/jacksonville_nc_osm_lane_001.json
"""
...
OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "reports",
                   "jacksonville_nc_osm_lane_001.json")
...
def build():
    ...
    return OrderedDict([
        ...
        ("source", OrderedDict([
            ...
            ("pbf_snapshot",
             "the 2026-09-10 Geofabrik download, reused (hard link) from the Charlotte / Triad / Fayetteville runs' local copy; the "
