"""PTF-ATLANTA-GA-PARALLEL-SOURCE-READY-001 -- Phases 13 and 14: the clean set.
...
Output:
  launch_packages/pettripfinder/markets/reports/atlanta_ga_clean_authority_001.json
"""
...
def main(argv=None):
    ...
    ap.add_argument("--out", default=os.path.join(REPORTS, "atlanta_ga_clean_authority_001.json"))
