"""PTF-FORT-LAUDERDALE-FL-HARDENED-SOURCE-READY-001 -- Phase 12F: Extended Stay America, the plain-client lane.

Extended Stay America's own Fort Lauderdale city page (https://www.extendedstayamerica.com/hotels/fl/
fort-lauderdale) answers a
...
persisted by sha256 under data/acquisition/fort_lauderdale_fl_esa_001/.

Also reads the Hollywood, Davie, Plantation, Sunrise, Pembroke Pines, Coral Springs and Deerfield Beach city
pages directly, since a single Fort Lauderdale city-page walk may not surface every suburban Broward property.

Outputs:
  launch_packages/pettripfinder/markets/staging/fort-lauderdale-fl/raw_captures/esa_rows.json
  launch_packages/pettripfinder/markets/reports/fort_lauderdale_fl_esa_lane_001.json
"""
...
from scripts.pettripfinder import fort_lauderdale_fl_brand_inventory_001 as B  # noqa: E402

WORK_ORDER = "PTF-FORT-LAUDERDALE-FL-HARDENED-SOURCE-READY-001"
B.DOCS = os.path.join(_DASH, "data", "acquisition", "fort_lauderdale_fl_esa_001")
CITY_PAGES = [
    "https://www.extendedstayamerica.com/hotels/fl/fort-lauderdale",
    "https://www.extendedstayamerica.com/hotels/fl/hollywood",
    "https://www.extendedstayamerica.com/hotels/fl/davie",
    "https://www.extendedstayamerica.com/hotels/fl/plantation",
    "https://www.extendedstayamerica.com/hotels/fl/sunrise",
    "https://www.extendedstayamerica.com/hotels/fl/pembroke-pines",
    "https://www.extendedstayamerica.com/hotels/fl/coral-springs",
    "https://www.extendedstayamerica.com/hotels/fl/deerfield-beach",
]
RAW_OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "staging", "fort-lauderdale-fl", "raw_captures", "esa_rows.json")
REPORT_OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "reports", "fort_lauderdale_fl_esa_lane_001.json")
OUT_OF_MARKET_TOWNS = ("miami", "miami-beach", "miami-lakes", "doral", "coral-gables", "hialeah",
                       "north-miami", "north-miami-beach", "aventura", "sunny-isles-beach", "kendall",
                       "homestead", "florida-city", "miami-gardens", "boca-raton", "delray-beach",
                       "boynton-beach", "west-palm-beach", "palm-beach-gardens", "jupiter", "key-largo",
                       "key-west", "islamorada", "marathon", "naples", "fort-myers", "orlando", "tampa")
...
def main():
    ...
    for city_url in CITY_PAGES:
        ...
        # BROWARD: the brand serves its Florida city pages with RELATIVE property links ("/hotels/fl/
        # fort-lauderdale/cypress-creek-park-north"), not the absolute form Miami's pages carried.
    ...
    with open(REPORT_OUT, "w", encoding="utf-8", newline="\n") as fh:
        json.dump(OrderedDict([
            ("schema", "ptf-brand-first-party-lane/1.0"), ("work_order", WORK_ORDER), ("market_id", "fort-lauderdale-fl"),
