"""PTF-MIAMI-FL-BROWSER-CLOSURE-002 -- Phases 8-11: BEFORE vs AFTER, and the non-browser unresolved audit.

BEFORE is the sealed base d7756467's own committed accounting (read from git, never retyped). AFTER is this pass's
...
Output: launch_packages/pettripfinder/markets/reports/miami_fl_closure_accounting_002.json
"""
...
BASE_SHA = "d7756467710e74da81f5f4a4526cda91ce64eab1"
PKG = os.path.join(_DASH, "launch_packages", "pettripfinder")
REPORTS = os.path.join(PKG, "markets", "reports")
RAW = os.path.join(PKG, "markets", "staging", "miami-fl", "raw_captures")
OUT = os.path.join(REPORTS, "miami_fl_closure_accounting_002.json")
...
PHASE10 = OrderedDict([
    ("BROWSER_CAPTURE_NEEDED", ("ACTIONABLE_NOW", "the authorized browser lane exists for this row; it was not "
                                                  "reached in this pass's window")),
...
def main():
    ...
    closure = _load(os.path.join(REPORTS, "miami_fl_browser_closure_002.json"), {}) or {}
