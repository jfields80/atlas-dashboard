"""PTF-TOLEDO-OH-NEW-MARKET-001 -- Phase 12, the attended browser pass.
...
----------------------------------------
This pass is what settles that. Marriott's TOL prefix reaches Findlay (45840,
45839), Port Clinton (43452) and Wauseon (43567), and Hilton's Toledo-area city
pages list a Wauseon Tru. Every one of those was captured and every one is
...
def build(rows_path):
    ...
    return OrderedDict([
        ...
        ("a_code_selects_the_page_admits",
         "Marriott's TOL prefix reaches Findlay, Port Clinton and Wauseon, and Hilton's "
         "Toledo-area city pages list a Wauseon Tru. All four were captured and all four are "
         "OUTSIDE_MARKET on the address their own pages state."),
        ("radisson_row_not_read", src.get("radisson")),
        ("counts", OrderedDict([
            ("pages_read", len(out)),
