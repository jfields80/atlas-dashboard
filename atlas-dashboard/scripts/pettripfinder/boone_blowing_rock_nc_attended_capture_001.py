"""PTF-BOONE-BLOWING-ROCK-NC-PARALLEL-SOURCE-READY-001 -- Phases 10-14: the first-party policy reads.

Cloned from the Outer Banks NC capture helper (itself from Greenville NC). Families and surfaces:
  ...
  WYNDHAM   plain-client reads (``boone_blowing_rock_nc_wyndham_lane_001``): the overview page
...
``data/acquisition/boone_blowing_rock_nc_attended/``; each payload file's canonical JSON
...
Output:
  launch_packages/pettripfinder/markets/reports/boone_blowing_rock_nc_attended_capture_001.json
"""
...
RAW = os.path.join(PKG, "markets", "staging", "boone-blowing-rock-nc", "raw_captures")
REGISTRY = os.path.join(REPORTS, "boone_blowing_rock_nc_corridor_registry_001.json")
OUT = os.path.join(REPORTS, "boone_blowing_rock_nc_attended_capture_001.json")
...
PAYLOAD_DIGESTS = OrderedDict([
    ("hilton_rows.json", "0fa8cecbdf35c5797bebe471b904ae3c9281734f77db98e59a1270ddf0d74d39"),
    ("marriott_rows.json", "6fec8b392e976107c148743933fa41c95aa2ae7dfbfa625474db2269c47e3a97"),
    ("ihg_rows.json", "bf523ad0df073cdda66b40c14ff2e396be25787847d54a3993217e26a2294153"),
])
