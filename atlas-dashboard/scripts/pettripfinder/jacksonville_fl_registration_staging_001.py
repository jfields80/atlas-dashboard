"""PTF-JACKSONVILLE-FL-HARDENED-SOURCE-READY-001 -- Phase 27A: STAGE Jacksonville's authority.
...
package root, because the root is where a REGISTERED market's documents live and Jacksonville is registered
...
def build():
    ...
    package = OrderedDict([
        ("market", "Jacksonville, Florida"), ("schema_version", PS.SCHEMA_VERSION), ("market_id", MARKET_ID),
        ("work_order", WORK_ORDER), ("as_of", OBSERVED_AT),
        ("note", "Jacksonville / Northeast Florida' REGISTERED policy package. Every record is "
    ...
    authority = OrderedDict([
        ...
        ("what_this_is", "Jacksonville / Northeast Florida' authority as the source-ready order proposed it, REGISTERED "
