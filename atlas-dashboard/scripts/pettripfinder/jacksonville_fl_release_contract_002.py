"""PTF-JACKSONVILLE-FL-REGISTRATION-AND-STAGING-002 -- Jacksonville's release contract.
...
WORK_ORDER = "PTF-JACKSONVILLE-FL-REGISTRATION-AND-STAGING-002"
...
def main(argv=None) -> int:
    ...
    clean = _load(os.path.join(REPORTS, "jacksonville_fl_clean_authority_001.json"))
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-jacksonville-fl"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Jacksonville / Northeast Florida market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Jacksonville at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             "%d registered identities, built from zero by %s on the West-Palm-Beach-live hardened "
             "lineage and closed in that same order through the supported attended-browser lane "
             "(120 paced attempts, 75 first-party brand reads, no paid provider, no relay, no "
             "browser-JS exfiltration and no Akamai bypass), registered by %s. Membership is this "
             "market's own corridor postal partition (census_membership_basis CORRIDOR_REGISTRY): "
             "17 corridors over 47 admitted postal codes across FOUR counties, three of them "
             "SPLIT. DUVAL is admitted whole because it is a consolidated city-county whose single "
             "postal city name covers 25 lodging-bearing codes over 39 miles; CLAY is admitted "
             "except Keystone Heights, which is 45 miles inland in the Trail Ridge lake district "
             "and orients to Gainesville; NASSAU is admitted with Amelia Island at CORRIDOR tier "
             "and the mainland at FRINGE; and ST. JOHNS is admitted only at Ponte Vedra Beach and "
             "Fruit Cove. EVERY ST. AUGUSTINE POSTAL CODE IS REFUSED -- 110 hotel-rank licences "
             "under the city names, 29 more in 32080 and 9 in 32092 -- because that is a market in "
             "its own right and absorbing it would destroy a future one; Flagler, Putnam, Baker, "
             "Alachua and Volusia are likewise named, refused and preserved. JAX airport IS a "
             "corridor because it owns 32218, the market's largest hotel-rank code; JAXPORT, Naval "
             "Station Mayport, NAS Jacksonville and the Mayo Clinic campus are NOT corridors "
             "because none owns a hotel-bearing postal code and Mayport and NAS Jax carry zero "
             "lodging licences at all. The city name JACKSONVILLE decides nothing here: "
             "jacksonville-nc is a LIVE market in Onslow County, North Carolina, and membership is "
             "decided by the property's own postal code and never by its name. Resort condominium "
             "units, vacation dwellings, non-transient apartments, rental-management portfolios, "
             "member-only club lodging and timeshare inventory are never admitted -- Nassau County "
             "alone carries 1,130 resort-condominium licences against 32 hotel-rank ones. Rows the "
             "identity graph did not admit are recorded, not dropped: %s."
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "jacksonville_fl_clean_authority_001.json with its class. No gate was lowered to "
                "preserve a count."
