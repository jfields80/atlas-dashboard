"""PTF-BOONE-BLOWING-ROCK-NC-PARALLEL-SOURCE-READY-001 -- Phase 4A: the OpenStreetMap lane.
...
Output:
  launch_packages/pettripfinder/markets/reports/boone_blowing_rock_nc_osm_lane_001.json
"""
...
def build():
    ...
    return OrderedDict([
        ...
        ("source", OrderedDict([
            ...
            ("pbf_snapshot",
             "the 2026-09-10 Geofabrik North Carolina download, reused (hard link) from the Outer Banks / "
             "Greenville runs' local copy; the upstream file has since been republished, so this md5 is "
             "the snapshot's own"),
