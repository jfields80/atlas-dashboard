"""PTF-PINEHURST-SOUTHERN-PINES-NC-PARALLEL-SOURCE-READY-001 -- Phases 13 and 14: the clean set.
...
Output:
  launch_packages/pettripfinder/markets/reports/pinehurst_southern_pines_nc_clean_authority_001.json
"""
...
ATTENDED = os.path.join(REPORTS, "pinehurst_southern_pines_nc_attended_capture_001.json")
STATIC = os.path.join(REPORTS, "pinehurst_southern_pines_nc_free_static_lane_001.json")
...
def main(argv=None):
    ...
    ap.add_argument("--out", default=os.path.join(REPORTS, "pinehurst_southern_pines_nc_clean_authority_001.json"))
