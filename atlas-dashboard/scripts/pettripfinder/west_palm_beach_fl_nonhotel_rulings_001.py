"""PTF-WEST-PALM-BEACH-FL-HARDENED-SOURCE-READY-001 -- the vacation-rental / timeshare / resort-residence / venue filter.
...
#: own first-party evidence was read. Palm Beach County's exposure is its COUNTRY-CLUB and equestrian stock
#: (Hunters Run, Breakers West, PGA National's villa programme, Wellington's show-season rentals): member-only
#: or guest-of-member lodging is not public lodging. A row is added here only after reading that row's own
#: evidence, mirroring the Orlando V2 precedent's Lake Nona Club / Bay Hill Club / Shades of Green entries.
NOT_LODGING_WHY = {
    # Each row here was proved by THIS market's own first-party read -- never inherited from another market.
    # Fort Lauderdale's Marriott's BeachPlace Towers ruling, for instance, belongs to Broward and is not
    # carried here; the Oceana Palms ruling below was read on this market's own property page.
    "marriott s oceana palms": (
        "TIMESHARE -- the brand's OWN property page for MARSHA code pbisn, read by the attended-browser lane "
        "on 2026-09-22, states the premises as 3200 North Ocean Drive, Riviera Beach 33404 and carries the "
        "heading 'MARRIOTT'S OCEANA PALMS, A MARRIOTT VACATION CLUB(R) RESORT' together with an Ownership "
        "section in both its main navigation and its footer. Vacation-ownership inventory is never admitted, "
        "whatever a destination bureau or a competitor directory files it under. Its page also states 'Pets "
        "Not Allowed'; that refusal is recorded as history and published NOWHERE, because an excluded row "
        "publishes nothing -- not even a refusal."),
}
...
#: public hotel operation (Singer Island, Highland Beach and the Delray / Boca oceanfronts carry many).
...
#: motels are licensed MOTL and named "... Apartment Motel" / "... Apartment Hotel"; Lake Worth Beach's Dixie
#: and Federal Highway motor-court row -- the densest motel row in this county -- carries the same vocabulary.
...
#: PALM BEACH COUNTY: a licence or listing whose own name is a COMPANY (LLC / Inc / management / realty) and not a hotel, or whose
#: own street is a unit inside a residential tower ("3800 N Ocean Dr Unit 1204", "Ste 210"), is a condo-unit rental
