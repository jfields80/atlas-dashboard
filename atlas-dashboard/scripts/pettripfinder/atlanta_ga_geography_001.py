...
#: REGISTERED by PTF-ATLANTA-GA-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 against the Jacksonville-live parent. The source-ready
#: order wrote markets/proposed/atlanta-ga.json (kept as history).
SHARD_OUT = os.path.join(PKG, "markets", "atlanta-ga.json")
...
def build():
    ...
    report = OrderedDict([
        ...
        ("registration_state",
         ...
         "PTF-ATLANTA-GA-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 against the Jacksonville-live parent (Atlanta is next in the founder's "
