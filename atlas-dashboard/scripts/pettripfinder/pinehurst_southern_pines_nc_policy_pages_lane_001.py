"""PTF-PINEHURST-SOUTHERN-PINES-NC-PARALLEL-SOURCE-READY-001 -- Phase 11B: the independents' own policy pages.

Sandhills independents publish their pet policy, when they publish one, on a subpage (``/pet-policy``,
...
``data/acquisition/pinehurst_southern_pines_nc_policy_pages_001/``).
...
recorded in ``markets/staging/pinehurst-southern-pines-nc/raw_captures/brand_pages.json``
with the sha256 of the document they were read from, and the capture helper binds
them.

Output:
  launch_packages/pettripfinder/markets/reports/pinehurst_southern_pines_nc_policy_pages_lane_001.json
"""
...
from scripts.pettripfinder import pinehurst_southern_pines_nc_brand_inventory_001 as B  # noqa: E402
from scripts.pettripfinder import pinehurst_southern_pines_nc_static_lane_001 as S      # noqa: E402
...
STATIC = os.path.join(REPORTS, "pinehurst_southern_pines_nc_static_lane_001.json")
OUT = os.path.join(REPORTS, "pinehurst_southern_pines_nc_policy_pages_lane_001.json")
DOCS = os.path.join(_DASH, "data", "acquisition", "pinehurst_southern_pines_nc_policy_pages_001")
LINK_CAP = 6
...
EXTRA_TARGETS = [
    ("https://1878bedandbreakfast.com/", "1878 bed and breakfast"),
    ("https://www.pinehurst.com/accommodations/", "pinehurst resort"),
    ("https://www.pinehurst.com/accommodations/the-magnolia-inn/", "the magnolia inn"),
    ("https://www.pinehurst.com/accommodations/villas-condos/", "pinehurst resort"),
    ("https://www.pinehurst.com/faq/", "pinehurst resort"),
    ("https://www.knollwoodhouse.com/", "knollwood house"),
    ("https://www.amerivuinn.com/", "amerivu inn and suites aberdeen"),
]
