    ...
    candidates = [
        ...
        item(by_key["sonesta simply suites pittsburgh airport"], "PUBLICATION_CANDIDATE",
             ...
             facts={"pets_allowed": True, "pet_count_limit": 2,
                    "weight_limit_stated_none": True, "breed_restrictions_stated_none": True,
        ...
        item(by_key["hyatt house pittsburgh bloomfield shadyside"], "PUBLICATION_CANDIDATE",
             ...
             facts={"pets_allowed": True, "pet_count_limit": 2,
                    ...
                    "fee_tiers": [{"amount_cents": 7500, "currency": "USD", "stay_nights": {"min": 1, "max": 6}}, {"amount_cents": 27500, "currency": "USD", "stay_nights": {"min": 7, "max": 30}}]},
             withheld=[{"field": "fee_basis", "reason_code": "SOURCE_AMBIGUOUS"}],
        ...
        item(by_key["hyatt place pittsburgh north shore"], "PUBLICATION_CANDIDATE",
             ...
             facts={"pets_allowed": True, "species": {"dogs": "accepted"}, "fee_tiers": [{"amount_cents": 7500, "currency": "USD", "stay_nights": {"min": 1, "max": 6}}, {"amount_cents": 7500, "currency": "USD", "stay_nights": {"min": 7, "max": 30}}], "other_charges": [{"kind": "cleaning_fee", "amount_cents": 10000, "currency": "USD", "conditional": True, "trigger": "7 - 30 nights"}], "pet_count_limit": 2,
             ...
             withheld=[{"field": "fee_basis", "reason_code": "SOURCE_AMBIGUOUS"}],
             notes=["Refundability is absent for both the tiered fee and the cleaning fee. A stay-length tier is not a fee basis."], publication_grade=True, review_required=True),
