"""PTF-TAMPA-FL-HARDENED-V2-SOURCE-READY-001 -- Phase 9B: the OpenStreetMap lane.

Reads the local Geofabrik Florida extract (downloaded by this order on 2026-09-15) (ODbL, (c) OpenStreetMap
...
Output:
  launch_packages/pettripfinder/markets/reports/tampa_fl_v2_osm_lane_001.json
"""
...
OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "reports",
                   "tampa_fl_v2_osm_lane_001.json")

#: guest_house, chalet and apartment are kept too: Tampa Bay's vacation-rental and resort-condo stock,
#: especially on the Gulf beaches, is often tagged that way, and the census must SEE a rental to refuse it
#: by decision.
...
def build():
    ...
    return OrderedDict([
        ...
        ("source", OrderedDict([
            ...
            ("pbf_snapshot",
             "the 2026-09-15 Geofabrik Florida download made by this order (656,564,714 bytes); the upstream "
