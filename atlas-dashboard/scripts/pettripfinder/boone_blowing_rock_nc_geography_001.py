...
#: REGISTERED by PTF-BOONE-BLOWING-ROCK-NC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 against the Greenville-live parent. The source-ready
#: order wrote markets/proposed/boone-blowing-rock-nc.json (kept as history).
SHARD_OUT = os.path.join(PKG, "markets", "boone-blowing-rock-nc.json")
...
def build():
    ...
    report = OrderedDict([
        ...
        ("registration_state",
         ...
         "PTF-BOONE-BLOWING-ROCK-NC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 against the Greenville-live parent (the founder moved "
         "Boone - Blowing Rock to #21, ahead of Jacksonville). The source-ready order's markets/proposed/ copy is history."),
        ("membership_rule",
