"""PTF-TAMPA-FL-HARDENED-V2-SOURCE-READY-001 -- Phase 12A: one first-party route per census identity.
...
census ADMITTED, the first-party route it will be read at and which source stated it, in this order:
  ...
  2. the website the destination bureau (Visit Tampa Bay) links for the listing joined to this building;
...
Nothing here fetches. Output:
  launch_packages/pettripfinder/markets/reports/tampa_fl_v2_routing_001.json
"""
...
OUT = os.path.join(REPORTS, "tampa_fl_v2_routing_001.json")
...
_NOT_A_PROPERTY_ROUTE = re.compile(
    ...
    r"visittampabay\.com|visitstpeteclearwater\.com|bringfido|airbnb|vrbo|priceline|agoda|trivago|orbitz)", re.I)
