"""PTF-BOONE-BLOWING-ROCK-NC-PARALLEL-SOURCE-READY-001 -- Phase 10/11: the Wyndham first-party lane (plain client).
...
``data/acquisition/boone_blowing_rock_nc_wyndham_001/``. The pet quote is read from the
...
Output:
  data/acquisition/boone_blowing_rock_nc_attended/wyndham_rows.json   (the capture helper's input shape)
  launch_packages/pettripfinder/markets/reports/boone_blowing_rock_nc_wyndham_lane_001.json
"""
...
RAW_OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "staging", "boone-blowing-rock-nc", "raw_captures", "wyndham_rows.json")
REPORT_OUT = os.path.join(REPORTS, "boone_blowing_rock_nc_wyndham_lane_001.json")
B.DOCS = os.path.join(_DASH, "data", "acquisition", "boone_blowing_rock_nc_wyndham_001")
