"""PTF-MIAMI-FL-HARDENED-SOURCE-READY-001 -- the vacation-rental / timeshare / resort-residence / venue filter.
...
#: Rows refused by their OWN full normalised name, each with its reason. Empty at authoring time -- Greater Miami's
...
#: vocabulary (statewide, not Orlando-specific) is kept from the Orlando V2 precedent; Miami-specific resort
...
#: public hotel operation (Miami carries many). A brand-inventory or hotel-page read still overrides this.
...
#: MIAMI: a licence or listing whose own name is a COMPANY (LLC / Inc / management / realty) and not a hotel, or whose
#: own street is a unit inside a residential tower ("5445 Collins Ave Unit C17", "Ste Cu-6"), is a condo-unit rental
