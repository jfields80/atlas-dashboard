"""PTF-SAVANNAH-GA-PARALLEL-SOURCE-READY-001 -- Phase 11B: the independents' own policy pages.
...
``data/acquisition/savannah_ga_policy_pages_001/``).
...
recorded in ``markets/staging/savannah-ga/raw_captures/brand_pages.json``
with the sha256 of the document they were read from, and the capture helper binds
them.

Output:
  launch_packages/pettripfinder/markets/reports/savannah_ga_policy_pages_lane_001.json
"""
...
from scripts.pettripfinder import savannah_ga_static_lane_001 as S      # noqa: E402
...
STATIC = os.path.join(REPORTS, "savannah_ga_static_lane_001.json")
OUT = os.path.join(REPORTS, "savannah_ga_policy_pages_lane_001.json")
DOCS = os.path.join(_DASH, "data", "acquisition", "savannah_ga_policy_pages_001")
LINK_CAP = 6
...
EXTRA_TARGETS = [
    # WoodSpring, Drury and Sonesta property pages answer a plain client (the brand's own sitemap / site).
    ("https://www.woodspring.com/extended-stay-hotels/locations/georgia/savannah/woodspring-suites-savannah-west-chatham-parkway", "woodspring suites savannah west chatham"),
    ("https://www.woodspring.com/extended-stay-hotels/locations/georgia/savannah/woodspring-suites-savannah-garden-city", "woodspring suites savannah garden city"),
    ("https://www.woodspring.com/extended-stay-hotels/locations/georgia/savannah-hinesville-statesboro/woodspring-suites-savannah-pooler", "woodspring suites savannah pooler"),
    ("https://www.druryhotels.com/locations/savannah-ga/drury-plaza-hotel-savannah-pooler", "drury plaza hotel savannah pooler"),
    ("https://www.intownsuites.com/extended-stay-hotels/georgia/savannah/augusta-rd/", "intown suites extended stay savannah ga garden city"),
    # Competitor-lead identities with a first-party site (names only from the gap challenge), and the inns the
    # map names without a website tag.
    ("https://mcmillaninn.com/", "mcmillan inn"),
    ("https://www.greenpalminn.com/", "green palm inn"),
    ("https://www.zeiglerhouseinn.com/", "zeigler house inn"),
    ("https://www.mansiononforsythpark.com/", "mansion on forsyth park"),
    ("https://www.azaleainn.com/", "azalea inn and villas"),
    ("https://www.oldeharbourinn.com/pet-friendly.htm", "olde harbour inn"),
]
