"""PTF-OUTER-BANKS-NC-PARALLEL-SOURCE-READY-001 -- Phases 10-14: the first-party policy reads.
...
Cloned from the Greenville NC capture helper. Families and surfaces:
  ...
  WYNDHAM   plain-client reads (``outer_banks_nc_wyndham_lane_001``): the overview page
...
``data/acquisition/outer_banks_nc_attended/``; each payload file's canonical JSON
...
Output:
  launch_packages/pettripfinder/markets/reports/outer_banks_nc_attended_capture_001.json
"""
...
RAW = os.path.join(PKG, "markets", "staging", "outer-banks-nc", "raw_captures")
REGISTRY = os.path.join(REPORTS, "outer_banks_nc_corridor_registry_001.json")
OUT = os.path.join(REPORTS, "outer_banks_nc_attended_capture_001.json")
...
PAYLOAD_DIGESTS = OrderedDict([
    ("hilton_rows.json", "a5566170eaa867ae857ee252fd95de099d76a93948bcaa48e9bd1eeb07debd39"),
    ("marriott_rows.json", "45e9b24c33ec7b6c5015f3ee4d974b820a71d53dac9e95b3eb6d6a2c4c4348d3"),
    ("ihg_rows.json", "c2e3550531676aee4cd5fe1c7a01b5bd3d0dfc75587736189b884466dcadc4e9"),
])
