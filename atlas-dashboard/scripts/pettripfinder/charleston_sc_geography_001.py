...
#: REGISTERED by PTF-CHARLESTON-SC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 against the Richmond-live parent. The source-ready
#: order wrote markets/proposed/charleston-sc.json (kept as history).
SHARD_OUT = os.path.join(PKG, "markets", "charleston-sc.json")
...
def build():
    ...
    report = OrderedDict([
        ...
        ("registration_state",
         ...
         "PTF-CHARLESTON-SC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 against the Richmond-live parent (the founder moved Charleston to the front "
