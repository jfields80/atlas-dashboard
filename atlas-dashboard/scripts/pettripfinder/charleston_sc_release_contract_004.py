"""PTF-CHARLESTON-SC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 -- Charleston's release contract.
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-charleston"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Charleston market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Charleston at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             "%d registered identities, built from zero by PTF-CHARLESTON-SC-PARALLEL-SOURCE-READY-001 "
             "at $0 and no paid provider call, registered by %s. "
             "Membership is this market's own corridor postal partition "
             "(census_membership_basis CORRIDOR_REGISTRY): a multi-core historic, airport, interstate and coastal "
             "market of 14 corridors over 36 postal codes -- the Historic District, the Upper Peninsula, West Ashley, "
             "North Charleston / Hanahan, the CHS airport and Convention Center district, Mount Pleasant / Patriots "
             "Point and Daniel Island (CORE); James Island, Summerville, Goose Creek and Ladson (CORRIDOR); Folly "
             "Beach, Isle of Palms / Sullivan's Island and Johns Island (FRINGE). Kiawah Island and Seabrook Island "
             "are OUTSIDE by their own stated municipality inside 29455 and preserved for a future kiawah-seabrook-sc "
             "market; Moncks Corner, Awendaw, Ravenel, Edisto, Walterboro, Beaufort, Hilton Head, Bluffton, "
             "Georgetown and Myrtle Beach are named and refused. Address-key collisions publish both hotels only "
             "under same-campus rulings in identity_resolutions.json. Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in charleston_sc_clean_authority_001.json with its class. No gate was "
