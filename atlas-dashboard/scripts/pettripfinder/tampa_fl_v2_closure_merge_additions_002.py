"""PTF-TAMPA-FL-V2-TERMINAL-HOLD-CLOSURE-003 -- merges
tampa_fl_v2_closure_census_additions_002.json into both on-disk copies of the
Tampa identity census, appended at the end (existing rows are untouched
byte-for-byte in position and content -- additive only, per PHASE 2)."""
