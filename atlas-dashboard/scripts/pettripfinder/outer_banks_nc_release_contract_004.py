"""PTF-OUTER-BANKS-NC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 -- Outer Banks' release contract.
...
WORK_ORDER = "PTF-OUTER-BANKS-NC-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002"
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-outer-banks"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Outer Banks market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Outer Banks at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             "%d registered identities, built from zero by PTF-OUTER-BANKS-NC-PARALLEL-SOURCE-READY-001 "
             "at $0 and no paid provider call, registered by %s. "
             "Membership is this market's own corridor postal partition "
             "(census_membership_basis CORRIDOR_REGISTRY): a tourism market of 8 corridors over 10 postal codes -- "
             "Kitty Hawk / Southern Shores / Duck, Kill Devil Hills / Colington, Nags Head and Manteo / Roanoke "
             "Island (CORE); Wanchese and Corolla (CORRIDOR); Manns Harbor and Point Harbor / Powells Point / "
             "Harbinger (FRINGE). Hatteras Island (Rodanthe, Waves, Salvo, Avon, Buxton, Frisco, Hatteras) and "
             "Ocracoke are OUTSIDE and preserved for a future hatteras-ocracoke-nc submarket; vacation houses, "
             "condo units, cottage courts, rental agencies, timeshares and campgrounds are refused as non-hotel. "
             "Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in outer_banks_nc_clean_authority_001.json with its class. No gate was "
