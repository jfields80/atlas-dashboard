"""PTF-SAVANNAH-GA-PARALLEL-SOURCE-READY-001 -- Phase 4A: the OpenStreetMap lane.

Reads the local Geofabrik Georgia extract (ODbL, (c) OpenStreetMap
...
Output:
  launch_packages/pettripfinder/markets/reports/savannah_ga_osm_lane_001.json
"""
...
PBF = os.path.join(_DASH, "data", "osm_extracts", "georgia-latest.osm.pbf")
...
OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "reports",
                   "savannah_ga_osm_lane_001.json")

#: guest_house is kept too: Savannah's historic inns are often tagged guest_house, and the census
...
def build():
    ...
    return OrderedDict([
        ...
        ("source", OrderedDict([
            ("pbf", "data/osm_extracts/georgia-latest.osm.pbf"),
            ...
            ("pbf_snapshot",
             "the 2026-09-13 Geofabrik Georgia download, reused (hard link) from the Atlanta GA "
