"""PTF-WEST-PALM-BEACH-FL-HARDENED-SOURCE-READY-001 -- Phase 12F: Extended Stay America, the plain-client lane.

Extended Stay America's own West Palm Beach city page (https://www.extendedstayamerica.com/hotels/fl/
west-palm-beach) answers a
...
persisted by sha256 under data/acquisition/west_palm_beach_fl_esa_001/.

Also reads the Palm Beach Gardens, Jupiter, Boca Raton, Delray Beach, Boynton Beach, Lake Worth and Wellington
city pages directly, since a single West Palm Beach city-page walk may not surface every Palm Beach County
property.

Outputs:
  launch_packages/pettripfinder/markets/staging/west-palm-beach-fl/raw_captures/esa_rows.json
  launch_packages/pettripfinder/markets/reports/west_palm_beach_fl_esa_lane_001.json
"""
...
from scripts.pettripfinder import west_palm_beach_fl_brand_inventory_001 as B  # noqa: E402

WORK_ORDER = "PTF-WEST-PALM-BEACH-FL-HARDENED-SOURCE-READY-001"
B.DOCS = os.path.join(_DASH, "data", "acquisition", "west_palm_beach_fl_esa_001")
CITY_PAGES = [
    "https://www.extendedstayamerica.com/hotels/fl/west-palm-beach",
    "https://www.extendedstayamerica.com/hotels/fl/palm-beach-gardens",
    "https://www.extendedstayamerica.com/hotels/fl/jupiter",
    "https://www.extendedstayamerica.com/hotels/fl/boca-raton",
    "https://www.extendedstayamerica.com/hotels/fl/delray-beach",
    "https://www.extendedstayamerica.com/hotels/fl/boynton-beach",
    "https://www.extendedstayamerica.com/hotels/fl/lake-worth",
    "https://www.extendedstayamerica.com/hotels/fl/wellington",
]
RAW_OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "staging", "west-palm-beach-fl", "raw_captures", "esa_rows.json")
REPORT_OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "reports", "west_palm_beach_fl_esa_lane_001.json")
OUT_OF_MARKET_TOWNS = ("fort-lauderdale", "hollywood", "dania-beach", "hallandale-beach", "pompano-beach",
                       "deerfield-beach", "plantation", "davie", "sunrise", "weston", "pembroke-pines",
                       "miramar", "coral-springs", "tamarac", "lauderhill", "margate",
                       "miami", "miami-beach", "miami-lakes", "doral", "coral-gables", "hialeah",
                       "north-miami", "north-miami-beach", "aventura", "sunny-isles-beach", "kendall",
                       "homestead", "florida-city", "miami-gardens", "stuart", "hobe-sound",
                       "port-st-lucie", "fort-pierce", "vero-beach", "key-largo",
...
def main():
    ...
    with open(REPORT_OUT, "w", encoding="utf-8", newline="\n") as fh:
        json.dump(OrderedDict([
            ("schema", "ptf-brand-first-party-lane/1.0"), ("work_order", WORK_ORDER), ("market_id", "west-palm-beach-fl"),
