"""PTF-CHARLESTON-SC-PARALLEL-SOURCE-READY-001 -- Phases 10-14: the first-party policy reads.

Cloned from the Boone - Blowing Rock NC capture helper (itself from Outer Banks NC and Atlanta GA). Families and surfaces:
  ...
  WYNDHAM   plain-client reads (``charleston_sc_wyndham_lane_001``): the overview page
...
``data/acquisition/charleston_sc_attended/``; each payload file's canonical JSON
...
Output:
  launch_packages/pettripfinder/markets/reports/charleston_sc_attended_capture_001.json
"""
...
RAW = os.path.join(PKG, "markets", "staging", "charleston-sc", "raw_captures")
REGISTRY = os.path.join(REPORTS, "charleston_sc_corridor_registry_001.json")
OUT = os.path.join(REPORTS, "charleston_sc_attended_capture_001.json")
...
PAYLOAD_DIGESTS = OrderedDict([
    ("hilton_rows.json", "48196baa2e3250e940e574c816639229eeab3cc3ee48a0daa1371c34cc49f492"),
    ("marriott_rows.json", "81e482feb6d3b5eedb738c54ba23214ef3c667562ef353a6c162f878a47bd81d"),
    ("ihg_rows.json", "2eb3942ce51771f9730add7814dc0fda05b85e8b2985f143a868683b28706801"),
    ("choice_rows.json", "40abf2d1c66f4a37cf094a4a029f78b0d725b263a4ac4d19e32c23b8e1226744"),
    ("hyatt_rows.json", "145377e96c2243ce52a759b76b4c2733149d96c10e8310ba723af172d5f862e4"),
    ("bestwestern_rows.json", "a6e309c56dcc074159052371d55865d25cb512d2d0f760886506afeee8058bac"),
])
