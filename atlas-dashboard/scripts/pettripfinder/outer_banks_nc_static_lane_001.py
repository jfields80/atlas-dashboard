"""PTF-OUTER-BANKS-NC-PARALLEL-SOURCE-READY-001 -- Phase 10/11: the free static first-party lane.
...
addressed by sha256, under ``data/acquisition/outer_banks_nc_static_001/``, and this
...
recorded in ``outer_banks_nc_attended/brand_pages.json`` with the document sha256 they
...
Output:
  launch_packages/pettripfinder/markets/reports/outer_banks_nc_static_lane_001.json
"""
...
OUT = os.path.join(REPORTS, "outer_banks_nc_static_lane_001.json")
B.DOCS = os.path.join(_DASH, "data", "acquisition", "outer_banks_nc_static_001")
