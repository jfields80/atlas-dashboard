"""PTF-BOONE-BLOWING-ROCK-NC-PARALLEL-SOURCE-READY-001 -- Phases 13 and 14: the clean set.
...
Output:
  launch_packages/pettripfinder/markets/reports/boone_blowing_rock_nc_clean_authority_001.json
"""
...
def main(argv=None):
    ...
    ap.add_argument("--out", default=os.path.join(REPORTS, "boone_blowing_rock_nc_clean_authority_001.json"))
