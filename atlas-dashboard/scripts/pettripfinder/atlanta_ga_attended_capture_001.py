"""PTF-ATLANTA-GA-PARALLEL-SOURCE-READY-001 -- Phases 10-14: the first-party policy reads.

Cloned from the Greenville NC capture helper. Families and surfaces:
  ...
  WYNDHAM   plain-client reads (``atlanta_ga_wyndham_lane_001``): the overview page
...
``data/acquisition/atlanta_ga_attended/``; each payload file's canonical JSON
...
Output:
  launch_packages/pettripfinder/markets/reports/atlanta_ga_attended_capture_001.json
"""
...
RAW = os.path.join(PKG, "markets", "staging", "atlanta-ga", "raw_captures")
REGISTRY = os.path.join(REPORTS, "atlanta_ga_corridor_registry_001.json")
OUT = os.path.join(REPORTS, "atlanta_ga_attended_capture_001.json")
...
PAYLOAD_DIGESTS = OrderedDict([
    ("marriott_rows.json", "6e3bbb6f94e2c2f11b5938540585737f2f676722ebec211dae4c2657928060c5"),
    ("hilton_rows.json", "71a231acaa21bfb848f12d08d13a6a111cea386691cd237acdc71add9b9f4e15"),
    ("ihg_rows.json", "15e3c03187f50cef4aca7c04f4e4d98f41e62c731ae4f92cd5c045a0e74c05ad"),
    ("choice_rows.json", "e03c70f4436f39fb18dd495a40c8cf1404d1371cfce1e938943818655f892ed2"),
    ("hyatt_rows.json", "be05aac743c064949c737d60c5dfff3818f8c32bbe276b16b281402c49a691b4"),
])
