"""PTF-OUTER-BANKS-NC-PARALLEL-SOURCE-READY-001 -- Phases 13 and 14: the clean set.
...
Output:
  launch_packages/pettripfinder/markets/reports/outer_banks_nc_clean_authority_001.json
"""
...
def main(argv=None):
    ...
    ap.add_argument("--out", default=os.path.join(REPORTS, "outer_banks_nc_clean_authority_001.json"))
