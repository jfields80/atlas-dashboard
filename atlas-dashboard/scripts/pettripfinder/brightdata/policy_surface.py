...
PROPERTY_CODE_PATTERNS: Dict[str, str] = {
    ...
    # Carried onto this lineage by PTF-DETROIT-ANN-ARBOR-HARDENED-SYNC-029 as
    # an ALTERNATION rather than a replacement: the older country/city shape
    # still matches, so no market that relied on it loses its code.
