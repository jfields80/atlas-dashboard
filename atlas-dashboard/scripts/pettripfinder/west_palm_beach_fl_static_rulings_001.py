"""PTF-WEST-PALM-BEACH-FL-HARDENED-SOURCE-READY-001 -- identity-only reads and competitor leads.
...
(``west_palm_beach_fl_competitor_challenge_001.json``) when it exists. A lead proposes and never decides; its pet claims are
never read.
"""
