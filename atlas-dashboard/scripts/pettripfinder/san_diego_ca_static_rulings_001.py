"""PTF-SAN-DIEGO-CA-HARDENED-SOURCE-READY-001 -- identity-only reads and competitor leads.
...
(``san_diego_ca_competitor_challenge_001.json``) when it exists. A lead proposes and never decides; its pet claims are
never read.
"""
