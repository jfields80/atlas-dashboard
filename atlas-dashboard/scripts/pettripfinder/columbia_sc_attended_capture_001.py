"""PTF-COLUMBIA-SC-PARALLEL-SOURCE-READY-001 -- Phases 10-14: the first-party policy reads.
...
Cloned from the Charleston SC capture helper (itself from Savannah GA, Boone - Blowing Rock NC and Atlanta GA). Families and surfaces:
  ...
  WYNDHAM   plain-client reads (``columbia_sc_wyndham_lane_001``): the overview page
...
``data/acquisition/columbia_sc_attended/``; each payload file's canonical JSON
...
Output:
  launch_packages/pettripfinder/markets/reports/columbia_sc_attended_capture_001.json
"""
...
RAW = os.path.join(PKG, "markets", "staging", "columbia-sc", "raw_captures")
REGISTRY = os.path.join(REPORTS, "columbia_sc_corridor_registry_001.json")
OUT = os.path.join(REPORTS, "columbia_sc_attended_capture_001.json")
...
PAYLOAD_DIGESTS = OrderedDict([
    ("ihg_rows.json", "4f9a6a96fcefb20828ec710f53d4c1d79b089e893e38ca7ce24cda4afe058b51"),
    ("hyatt_rows.json", "ba995496c88855ed96432a48c4ea1c0a675d0df19231dbcd8221b540c4a86f94"),
    ("hilton_rows.json", "afd47cf6cc394e7e1e682f58ff1ad9c26ac752b588758aa31be7f44345035eaa"),
    ("marriott_rows.json", "9c5e4970114af71ebefeb89c9fa77307b86be225073ca03655372db828191557"),
    ("choice_rows.json", "31a7b53a9b8e370fec35a84c2e78f1b8497b8a395e54e1196e08fa33d107c9c3"),
    ("bestwestern_rows.json", "06c941e34171ac62efe17bdabc6c20e7b6e3ee9c3724e3641a661f6faacdf0c6"),
])
...
def build():
    ...
    for r in _load(os.path.join(RAW, "marriott_rows.json"), []):
        ...
        sig = OrderedDict([("name_on_page", r.get("n")), ("address_on_page", r.get("st")),
                           ("postal_code", (r.get("z") or "")[:5]), ("locality", r.get("ci")),
                           ("region", "SC"), ("phone_on_page", r.get("ph")), ("property_code_on_page", code),
    ...
    for r in _load(os.path.join(RAW, "ihg_rows.json"), []):
        ...
        sig = OrderedDict([("name_on_page", r.get("n") or name), ("address_on_page", r.get("st")),
                           ("postal_code", (r.get("z") or "")[:5]), ("locality", r.get("ci")), ("region", "SC"),
    ...
    for r in _load(os.path.join(RAW, "choice_rows.json"), []):
        ...
        u = "https://www.choicehotels.com/south-carolina/%s/%s" % (r["path"], r["c"])
        sig = OrderedDict([("name_on_page", r.get("n")), ("address_on_page", r.get("st")),
                           ("postal_code", (r.get("z") or "")[:5]), ("locality", r.get("ci")), ("region", "SC"),
                           ("phone_on_page", r.get("ph")), ("property_code_on_page", r["c"]),
                           ("lat", _f(r.get("la"))), ("lng", _f(r.get("lo")))])
    ...
    for extra in _load(os.path.join(RAW, "brand_pages.json"), []) + BRAND_PAGES:
        sig = OrderedDict([("name_on_page", extra["name"]), ("address_on_page", extra["street"]),
                           ("postal_code", extra["postal"]), ("locality", extra["city"]), ("region", "SC"),
