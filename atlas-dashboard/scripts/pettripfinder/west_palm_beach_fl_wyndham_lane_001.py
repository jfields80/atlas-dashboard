"""PTF-WEST-PALM-BEACH-FL-HARDENED-SOURCE-READY-001 -- Phase 12B: the Wyndham first-party lane (plain client).
...
Both documents are persisted as returned, addressed by sha256, under ``data/acquisition/west_palm_beach_fl_wyndham_001/``.
...
Palm Beach County place. A route admits nothing -- the postal code the property service states
decides.

Output:
  launch_packages/pettripfinder/markets/staging/west-palm-beach-fl/raw_captures/wyndham_rows.json
  launch_packages/pettripfinder/markets/reports/west_palm_beach_fl_wyndham_lane_001.json
"""
...
RAW_OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "staging", "west-palm-beach-fl", "raw_captures", "wyndham_rows.json")
REPORT_OUT = os.path.join(REPORTS, "west_palm_beach_fl_wyndham_lane_001.json")
B.DOCS = os.path.join(_DASH, "data", "acquisition", "west_palm_beach_fl_wyndham_001")
