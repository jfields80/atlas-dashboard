"""PTF-HICKORY-NC-PARALLEL-SOURCE-READY-001 -- Phases 10-14: the first-party policy reads.
...
Cloned from the Boone - Blowing Rock NC capture helper (Outer Banks, Greenville lineage). Families and surfaces:
  ...
  WYNDHAM   plain-client reads (``hickory_nc_wyndham_lane_001``): the overview page
...
``data/acquisition/hickory_nc_attended/``; each payload file's canonical JSON
...
Output:
  launch_packages/pettripfinder/markets/reports/hickory_nc_attended_capture_001.json
"""
...
RAW = os.path.join(PKG, "markets", "staging", "hickory-nc", "raw_captures")
REGISTRY = os.path.join(REPORTS, "hickory_nc_corridor_registry_001.json")
OUT = os.path.join(REPORTS, "hickory_nc_attended_capture_001.json")
...
PAYLOAD_DIGESTS = OrderedDict([
    ("hilton_rows.json", "c27368f581e4f0732498b847718c383a0e8cee2bcd629843a5a1bf25fb89765c"),
    ("marriott_rows.json", "6852a11bcc905847e22e0560f11aa2e6bde7e9c08be0dbbb765aad39291eba87"),
    ("ihg_rows.json", "e6e31d2e9bd3a8826a23f00951ea6515959eae75c0e2453db66a68eb2efd4b3f"),
])
