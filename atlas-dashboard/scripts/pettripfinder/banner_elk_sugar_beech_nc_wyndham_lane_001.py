"""PTF-BANNER-ELK-SUGAR-BEECH-NC-PARALLEL-SOURCE-READY-001 -- Phase 10/11: the Wyndham first-party lane (plain client).
...
``data/acquisition/banner_elk_sugar_beech_nc_wyndham_001/``. The pet quote is read from the
...
Output:
  data/acquisition/banner_elk_sugar_beech_nc_attended/wyndham_rows.json   (the capture helper's input shape)
  launch_packages/pettripfinder/markets/reports/banner_elk_sugar_beech_nc_wyndham_lane_001.json
"""
...
RAW_OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "staging", "banner-elk-sugar-beech-nc", "raw_captures", "wyndham_rows.json")
REPORT_OUT = os.path.join(REPORTS, "banner_elk_sugar_beech_nc_wyndham_lane_001.json")
B.DOCS = os.path.join(_DASH, "data", "acquisition", "banner_elk_sugar_beech_nc_wyndham_001")
