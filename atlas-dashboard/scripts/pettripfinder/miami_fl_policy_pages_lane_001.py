"""PTF-MIAMI-FL-HARDENED-SOURCE-READY-001 -- Phase 12G: independents' own policy / FAQ / pet pages (plain client).
...
The sentences are the candidate quote; facts are read by the shared reader in miami_fl_policy_reads_001 and
judged by the first-party gate and the negation guard in the clean authority. Documents persisted by sha256 under
data/acquisition/miami_fl_policy_pages_001/.

Output:
  launch_packages/pettripfinder/markets/staging/miami-fl/raw_captures/policy_pages_rows.json
"""
