"""PTF-JACKSONVILLE-FL-HARDENED-SOURCE-READY-001 -- Phase 12E: Firecrawl ROUTE DISCOVERY on the two Firecrawl-routed families
...
could not make. The page is persisted by sha256 under data/acquisition/jacksonville_fl_firecrawl_discovery/ and only
the property ROUTES are read from it -- never a policy.

Attempt cap: 8 pages. Credit floor: 400.

Output: launch_packages/pettripfinder/markets/reports/jacksonville_fl_firecrawl_discovery_001.json
"""
...
DOCS = os.path.join(_DASH, "data", "acquisition", "jacksonville_fl_firecrawl_discovery")
OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "reports", "jacksonville_fl_firecrawl_discovery_001.json")
CAP = 12
FLOOR = 400
PAGES = [
    # CHOICE and IHG both refused this client's plain request at their sitemaps, so their own CITY pages are the
    # eligible Firecrawl targets -- the standing rule that a brand's own city page beats its sitemap.
    ("CHOICE", "https://www.choicehotels.com/florida/jacksonville/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/jacksonville-beach/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/orange-park/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/fernandina-beach/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/yulee/hotels"),
    ("CHOICE", "https://www.choicehotels.com/florida/atlantic-beach/hotels"),
    ("IHG", "https://www.ihg.com/destinations/us/en/united-states/florida/jacksonville-hotels"),
    ("IHG", "https://www.ihg.com/destinations/us/en/united-states/florida/jacksonville-beach-hotels"),
    ("IHG", "https://www.ihg.com/destinations/us/en/united-states/florida/orange-park-hotels"),
    ("IHG", "https://www.ihg.com/destinations/us/en/united-states/florida/fernandina-beach-hotels"),
]
CAP = 8
...
def main():
    ...
    doc = OrderedDict([
        ("schema", "ptf-firecrawl-discovery/1.0"), ("work_order", WORK_ORDER), ("market_id", "jacksonville-fl"),
