"""PTF-FORT-LAUDERDALE-FL-HARDENED-SOURCE-READY-001 -- Phases 10, 13, 20-25 and 29: the machine-readable accounting.
...
Output: launch_packages/pettripfinder/markets/reports/fort_lauderdale_fl_source_ready_accounting_001.json
"""
...
from scripts.pettripfinder.fort_lauderdale_fl_nonhotel_rulings_001 import exclusion_class  # noqa: E402

WORK_ORDER = "PTF-FORT-LAUDERDALE-FL-HARDENED-SOURCE-READY-001"
PKG = os.path.join(_DASH, "launch_packages", "pettripfinder")
R = os.path.join(PKG, "markets", "reports")
RAW = os.path.join(PKG, "markets", "staging", "fort-lauderdale-fl", "raw_captures")
OUT = os.path.join(R, "fort_lauderdale_fl_source_ready_accounting_001.json")
PARTITION = os.path.join(PKG, "markets", "staging", "fort-lauderdale-fl", "launch_package", "fort_lauderdale_fl_final_partition_001.json")
...
FAMILIES = [
    ("MARRIOTT", r"marriott|courtyard by marriott|courtyard marriott|courtyard fort lauderdale|courtyard ft lauderdale|courtyard oceanside|courtyard by|courtyard(?= (fort|ft|miami|downtown|airport|weston|plantation|coral))|residence inn|springhill|fairfield|towneplace|ac hotel|aloft|westin|sheraton|"
...
LUXURY_RX = re.compile(r"\b(ritz.?carlton|four seasons|conrad|w fort lauderdale|the dalmar|pier sixty.?six|"
...
def main():
    ...
    fc2 = L("fort_lauderdale_fl_firecrawl_pass_002.json", {}) or {}
    fc3 = L("fort_lauderdale_fl_firecrawl_pass_003.json", {}) or {}
    bpr = L("fort_lauderdale_fl_brand_page_reads_001.json", {}) or {}
    disc = L("fort_lauderdale_fl_firecrawl_discovery_001.json", {}) or {}
    static = L("fort_lauderdale_fl_free_static_capture_001.json", {}) or {}
    comp = L("fort_lauderdale_fl_competitor_challenge_001.json", {}) or {}
    recon = L("fort_lauderdale_fl_competitor_reconciliation_001.json", {}) or {}
    dbpr = L("fort_lauderdale_fl_dbpr_lane_001.json", {}) or {}
    osm = L("fort_lauderdale_fl_osm_lane_001.json", {}) or {}
    brand = L("fort_lauderdale_fl_brand_inventory_001.json", {}) or {}
    roster = L("fort_lauderdale_fl_destination_roster_001.json", {}) or {}
    routing = L("fort_lauderdale_fl_routing_001.json", {}) or {}
    wyndham = L("fort_lauderdale_fl_wyndham_lane_001.json", {}) or {}
    esa = L("fort_lauderdale_fl_esa_lane_001.json", {}) or {}
    places = L("fort_lauderdale_fl_places_route_discovery_001.json", {}) or {}
    ...
    creport = L("fort_lauderdale_fl_census_reconciliation_001.json", {}) or {}

    # corridors
    cor = OrderedDict()
    for slug, name, _a, klass, _m, _z, _d in GEO.CORRIDORS:
        cid = "fort-lauderdale-fl__" + slug
    ...
    doc = OrderedDict([
        ("schema", "ptf-source-ready-accounting/1.0"), ("work_order", WORK_ORDER), ("market_id", "fort-lauderdale-fl"),
        ...
        ("providers", OrderedDict([
            ...
            ("firecrawl", OrderedDict([
                ...
                ("retry_pass_why", "first-pass FIRECRAWL_MISMATCH rows re-attempted once after the census restated "
                                   "Broward grid streets in the ordinal spelling the pages use"),
