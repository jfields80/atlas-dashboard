"""PTF-MIAMI-FL-HARDENED-SOURCE-READY-001 -- Phase 12B: the Wyndham first-party lane (plain client).
...
Both documents are persisted as returned, addressed by sha256, under ``data/acquisition/miami_fl_wyndham_001/``.
...
Greater Miami or careful-evaluation place. A route admits nothing -- the postal code the property service states
decides.

Output:
  launch_packages/pettripfinder/markets/staging/miami-fl/raw_captures/wyndham_rows.json
  launch_packages/pettripfinder/markets/reports/miami_fl_wyndham_lane_001.json
"""
...
from scripts.pettripfinder import miami_fl_brand_inventory_001 as B  # noqa: E402
...
RAW_OUT = os.path.join(_DASH, "launch_packages", "pettripfinder", "markets", "staging", "miami-fl", "raw_captures", "wyndham_rows.json")
REPORT_OUT = os.path.join(REPORTS, "miami_fl_wyndham_lane_001.json")
B.DOCS = os.path.join(_DASH, "data", "acquisition", "miami_fl_wyndham_001")
