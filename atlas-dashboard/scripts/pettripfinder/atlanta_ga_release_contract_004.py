"""PTF-ATLANTA-GA-REGISTER-RESEAL-AND-AUTHORIZATION-PREP-002 -- Atlanta's release contract.
...
def main(argv=None) -> int:
    ...
    doc = OrderedDict([
        ...
        ("release_name_prefix", "prod-atlanta"),
        ("description",
         "Deterministic release-gate contract for the PetTripFinder Atlanta market through %s. "
        ...
        ("deployment_authorization", OrderedDict([
            ...
            ("means",
             ...
             "decision exists for Atlanta at %d published profiles."
        ...
        ("identity_census", OrderedDict([
            ...
            ("note",
             "%d registered identities, built from zero by PTF-ATLANTA-GA-PARALLEL-SOURCE-READY-001 "
             "at $0 and no paid provider call, registered by %s. "
             "Membership is this market's own corridor postal partition "
             "(census_membership_basis CORRIDOR_REGISTRY): a multi-core metro of 22 corridors over 103 postal "
             "codes -- Downtown, Midtown, Buckhead, the ATL airport, Perimeter, Cumberland / Galleria, Smyrna, "
             "Decatur / Emory and Southside Atlanta (CORE); airport south, Chamblee / Doraville, Marietta, North "
             "Fulton, Norcross / Peachtree Corners, Duluth / Johns Creek, Tucker / Stone Mountain, Kennesaw and "
             "Suwanee (CORRIDOR); Morrow, Stockbridge, Lithonia / Stonecrest and Douglasville (FRINGE). Acworth, "
             "Lawrenceville, Buford, Union City / Fairburn, Austell / Mableton, McDonough, Conyers, Cumming, "
             "Cartersville, Newnan, Peachtree City, Gainesville and Athens are named and refused. Two dual-brand "
             "buildings publish both hotels under same-campus rulings in identity_resolutions.json. Rows "
        ...
        ("reconciliation", OrderedDict(
            ...
            + [("note",
                ...
                "named in atlanta_ga_clean_authority_001.json with its class. No gate was "
