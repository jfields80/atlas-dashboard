...
from scripts.pettripfinder.charleston_sc_timings_009 import TIMINGS  # noqa: E402
...
def build():
    ...
    doc = OrderedDict([
        ...
        ("next_order", [
            ...
            "parent into worker/ptf-charleston-sc-market-001; the Atlanta binding of this shadow package is then invalid.",
            "Copy markets/proposed/charleston-sc.json -> markets/charleston-sc.json, identity_census_proposed/charleston-sc.json -> "
            "identity_census/charleston-sc.json and the staged launch_package documents (hotel_policy_facts_charleston-sc.json, "
            "charleston_sc_final_partition_007.json, the authority shard) into their registered paths; repoint the helpers' paths.",
