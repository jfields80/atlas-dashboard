"""PTF-CHARLESTON-SC-PARALLEL-SOURCE-READY-001 -- Phase 11B: the independents' own policy pages.
...
``data/acquisition/charleston_sc_policy_pages_001/``).
...
recorded in ``markets/staging/charleston-sc/raw_captures/brand_pages.json``
with the sha256 of the document they were read from, and the capture helper binds
them.

Output:
  launch_packages/pettripfinder/markets/reports/charleston_sc_policy_pages_lane_001.json
"""
...
from scripts.pettripfinder import charleston_sc_static_lane_001 as S      # noqa: E402
...
STATIC = os.path.join(REPORTS, "charleston_sc_static_lane_001.json")
OUT = os.path.join(REPORTS, "charleston_sc_policy_pages_lane_001.json")
DOCS = os.path.join(_DASH, "data", "acquisition", "charleston_sc_policy_pages_001")
LINK_CAP = 6
...
EXTRA_TARGETS = [
    # Brand property pages that answer a plain client (the brand's own sitemap routes).
    ("https://www.druryhotels.com/locations/charleston-sc/drury-plaza-hotel-north-charleston", "drury plaza hotel north charleston"),
    ("https://www.woodspring.com/extended-stay-hotels/locations/south-carolina/charleston/woodspring-suites-north-charleston", "woodspring suites north charleston airport i 526"),
    # Independents whose home page carries no pet wording: the operator's own FAQ / policy pages, read directly.
    ("https://www.fqicharleston.com/faq/", "french quarter inn"),
    ("https://www.victoriahouseinn.com/faq/", "victoria house inn"),
    ("https://www.victoriahouseinn.com/", "victoria house inn"),
    ("https://www.meetingstreetinn.com/faq/", "meeting street inn"),
    ("https://www.indigoinn.com/faq/", "indigo inn"),
    ("https://www.harbourviewcharleston.com/faq/", "harbourview inn"),
    ("https://www.palmettohotelcharleston.com/faq/", "the palmetto hotel charleston"),
    ("https://www.thecooper.com/faq/", "the cooper"),
    ("https://www.richemonthotel.com/faq/", "hotel richemont"),
    ("https://www.thechurchstreetinn.com/faq/", "church street inn historic charleston an ascend collection hotel"),
    ("https://www.shemcreekinn.com/", "shem creek inn"),
    ("https://bijoucharleston.com/faq", "bijou boutique inn"),
    ("https://www.firetowerchs.com/faq", "fire tower"),
    ("https://www.theryderhotel.com/pet-policy", "the ryder hotel"),
    ("https://www.francismarionhotel.com/policies/", "francis marion hotel"),
    ("https://www.radissonhotels.com/en-us/hotels/country-inn-summerville-sc", "country inn and suites summerville"),
    # Folly Beach's own visitor directory (visitfolly.com/stay-directory, 'Hotels & Inns') names eight hotels and
    # inns the map never addressed; each operator's own site is read here for its address and policy.
    ("https://www.hotelfolly.com/", "hotel folly"),
    ("https://www.beachsideboutiqueinn.com/", "beachside boutique inn"),
    ("https://www.follidayinn.com/", "folliday inn"),
    ("https://www.regattainn.com/", "regatta inn"),
    ("https://innatfollybeach.com/", "riverside inn and cottages"),
    ("https://www.verahotel.com", "vera hotel"),
    # Johns Island: the Dunlin sits on the Kiawah River (Johns Island), not on Kiawah Island.
    ("https://www.aubergeresorts.com/thedunlin/", "the dunlin auberge collection"),
]
