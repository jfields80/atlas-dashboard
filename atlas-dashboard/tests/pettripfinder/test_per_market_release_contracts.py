...
EXPECTED_RECONCILIATION = {
    ...
    # 74/16/96/160 -> 91/40/137/119 at PTF-CINCINNATI-FREE-LANE-
    ...
    # Five were added, not six: 'comfort suites' is a bare chain word that
...
class TestContractAgreesWithItsOwnAuthority:
    ...
    def test_verified_no_pets_is_scoped_to_the_market_that_owns_it(self):
        ...
        assert by_market == {COLUMBUS: 14, CLEVELAND: 51, DAYTON: 24,
                             ...
                             # 16 -> 40 at PTF-CINCINNATI-FREE-LANE-
