...
class TestCollisionAudits:
    ...
    def test_a_code_shared_across_two_BRANDS_is_still_allowed(self, committed):
        ...
        # The earlier Cleveland pair no longer contributes, but Grand Rapids
        # contributes its own valid IHG/Marriott ``grrse`` pair. This audit is
        # global and recomputed, while enforcement remains domain-scoped.
        assert shared == {"grrse": ["ihg.com", "marriott.com"]}
