...
def test_final_records_preserve_each_founder_ruling_and_governance():
    ...
    # PTF-PITTSBURGH-HARDENED-SYNC-004 Phase 5 (defect D1): the source states
    # this conditional cleaning fee and never says whether it is refundable.
    # Schema 1.3 added refundable_stated for exactly that, so the charge now
    # says the SOURCE was silent instead of asserting a boolean nobody wrote.
    # The amount, the trigger and the founder's ruling are untouched.
